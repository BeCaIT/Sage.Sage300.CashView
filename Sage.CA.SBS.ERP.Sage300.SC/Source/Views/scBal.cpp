...
#if !defined(DO_scBalAttribs)
 #define scBalBaseAttribs         scBalAttribs
#endif

#if !defined(DO_scBalBlkGet)
 #define scBalBaseBlkGet          scBalBlkGet
#endif

#if !defined(DO_scBalBlkPut)
 #define scBalBaseBlkPut          scBalBlkPut
#endif

#if !defined(DO_scBalBrowse)
 #define scBalBaseBrowse          scBalBrowse
#endif

#if !defined(DO_scBalCancel)
 #define scBalBaseCancel          scBalCancel
#endif

#if !defined(DO_scBalClose)
 #define scBalBaseClose           scBalClose
#endif

#if !defined(DO_scBalCmpNames)
 #define scBalBaseCmpNames        scBalCmpNames
#endif

#if !defined(DO_scBalCompose)
 #define scBalBaseCompose         scBalCompose
#endif

#if !defined(DO_scBalCreate)
 #define scBalBaseCreate          scBalCreate
#endif

#if !defined(DO_scBalDelete)
 #define scBalBaseDelete          scBalDelete
#endif

#if !defined(DO_scBalDirty)
 #define scBalBaseDirty           scBalDirty
#endif

#if !defined(DO_scBalDrop)
 #define scBalBaseDrop            scBalDrop
#endif

#if !defined(DO_scBalExists)
 #define scBalBaseExists          scBalExists
#endif

#if !defined(DO_scBalFetch)
 #define scBalBaseFetch           scBalFetch
#endif

#if !defined(DO_scBalFetchLock)
 #define scBalBaseFetchLock       scBalFetchLock
#endif

#if !defined(DO_scBalField)
 #define scBalBaseField           scBalField
#endif

#if !defined(DO_scBalFieldExists)
 #define scBalBaseFieldExists     scBalFieldExists
#endif

#if !defined(DO_scBalFieldName)
 #define scBalBaseFieldName       scBalFieldName
#endif

#if !defined(DO_scBalFields)
 #define scBalBaseFields          scBalFields
#endif

#if !defined(DO_scBalFilterCount)
 #define scBalBaseFilterCount     scBalFilterCount
#endif

#if !defined(DO_scBalFilterDelete)
 #define scBalBaseFilterDelete    scBalFilterDelete
#endif

#if !defined(DO_scBalFilterFetch)
 #define scBalBaseFilterFetch     scBalFilterFetch
#endif

#if !defined(DO_scBalFilterSelect)
 #define scBalBaseFilterSelect    scBalFilterSelect
#endif

#if !defined(DO_scBalGet)
 #define scBalBaseGet             scBalGet
#endif

#if !defined(DO_scBalInit)
 #define scBalBaseInit            scBalInit
#endif

#if !defined(DO_scBalInsert)
 #define scBalBaseInsert          scBalInsert
#endif

#if !defined(DO_scBalInstanceFieldList)
 #define scBalBaseInstanceFieldList  scBalInstanceFieldList
#endif

#if !defined(DO_scBalInstanceNotify)
 #define scBalBaseInstanceNotify  scBalInstanceNotify
#endif

#if !defined(DO_scBalInstanceOpen)
 #define scBalBaseInstanceOpen    scBalInstanceOpen
#endif

#if !defined(DO_scBalInstanceProtocol)
 #define scBalBaseInstanceProtocol scBalInstanceProtocol
#endif

#if !defined(DO_scBalInstanceSecurity)
 #define scBalBaseInstanceSecurity scBalInstanceSecurity
#endif

#if !defined(DO_scBalKey)
 #define scBalBaseKey             scBalKey
#endif

#if !defined(DO_scBalKeys)
 #define scBalBaseKeys            scBalKeys
#endif

#if !defined(DO_scBalName)
 #define scBalBaseName            scBalName
#endif

#if !defined(DO_scBalOpen)
 #define scBalBaseOpen            scBalOpen
#endif

#if !defined(DO_scBalOrder)
 #define scBalBaseOrder           scBalOrder
#endif

#if !defined(DO_scBalPost)
 #define scBalBasePost            scBalPost
#endif

#if !defined(DO_scBalPresents)
 #define scBalBasePresents        scBalPresents
#endif

#if !defined(DO_scBalProcess)
 #define scBalBaseProcess         scBalProcess
#endif

#if !defined(DO_scBalPut)
 #define scBalBasePut             scBalPut
#endif

#if !defined(DO_scBalRead)
 #define scBalBaseRead            scBalRead
#endif

#if !defined(DO_scBalReadLock)
 #define scBalBaseReadLock        scBalReadLock
#endif

#if !defined(DO_scBalRecordClear)
  #define scBalBaseRecordClear    scBalRecordClear
#endif

#if !defined(DO_scBalRecordGenerate)
  #define scBalBaseRecordGenerate scBalRecordGenerate
#endif

#if !defined(DO_scBalRevisionCancel)
 #define scBalBaseRevisionCancel  scBalRevisionCancel
#endif

#if !defined(DO_scBalRevisionExists)
 #define scBalBaseRevisionExists  scBalRevisionExists
#endif

#if !defined(DO_scBalRevisionPost)
 #define scBalBaseRevisionPost    scBalRevisionPost
#endif

#if !defined(DO_scBalRevisionRekey)
 #define scBalBaseRevisionRekey   scBalRevisionRekey
#endif

#if !defined(DO_scBalRevisionUnposted)
 #define scBalBaseRevisionUnposted scBalRevisionUnposted
#endif

#if !defined(DO_scBalSecurity)
 #define scBalBaseSecurity        scBalSecurity
#endif

#if !defined(DO_scBalTableEmpty)
 #define scBalBaseTableEmpty      scBalTableEmpty
#endif

#if !defined(DO_scBalType)
 #define scBalBaseType            scBalType
#endif

#if !defined(DO_scBalUnLock)
 #define scBalBaseUnLock          scBalUnLock
#endif

#if !defined(DO_scBalUpdate)
 #define scBalBaseUpdate          scBalUpdate
#endif

#if !defined(DO_scBalVerify)
 #define scBalBaseVerify          scBalVerify
#endif
...
#define scBalExtendedBaseAttribs           scBalBaseAttribs
#define scBalExtendedBaseBlkGet            scBalBaseBlkGet
#define scBalExtendedBaseBlkPut            scBalBaseBlkPut
#define scBalExtendedBaseBrowse            scBalBaseBrowse
#define scBalExtendedBaseCancel            scBalBaseCancel
#define scBalExtendedBaseClose             scBalBaseClose
#define scBalExtendedBaseCmpNames          scBalBaseCmpNames
#define scBalExtendedBaseCompose           scBalBaseCompose
#define scBalExtendedBaseCreate            scBalBaseCreate
#define scBalExtendedBaseDelete            scBalBaseDelete
#define scBalExtendedBaseDirty             scBalBaseDirty
#define scBalExtendedBaseDrop              scBalBaseDrop
#define scBalExtendedBaseExists            scBalBaseExists
#define scBalExtendedBaseFetch             scBalBaseFetch
#define scBalExtendedBaseFetchLock         scBalBaseFetchLock
#define scBalExtendedBaseField             scBalBaseField
#define scBalExtendedBaseFieldExists       scBalBaseFieldExists
#define scBalExtendedBaseFieldName         scBalBaseFieldName
#define scBalExtendedBaseFields            scBalBaseFields
#define scBalExtendedBaseFilterCount       scBalBaseFilterCount
#define scBalExtendedBaseFilterDelete      scBalBaseFilterDelete
#define scBalExtendedBaseFilterFetch       scBalBaseFilterFetch
#define scBalExtendedBaseFilterSelect      scBalBaseFilterSelect
#define scBalExtendedBaseGet               scBalBaseGet
#define scBalExtendedBaseInit              scBalBaseInit
#define scBalExtendedBaseInsert            scBalBaseInsert
#define scBalExtendedBaseInstanceFieldList scBalBaseInstanceFieldList
#define scBalExtendedBaseInstanceNotify    scBalBaseInstanceNotify
#define scBalExtendedBaseInstanceOpen      scBalBaseInstanceOpen
#define scBalExtendedBaseInstanceProtocol  scBalBaseInstanceProtocol
#define scBalExtendedBaseInstanceSecurity  scBalBaseInstanceSecurity
#define scBalExtendedBaseKey               scBalBaseKey
#define scBalExtendedBaseKeys              scBalBaseKeys
#define scBalExtendedBaseName              scBalBaseName
#define scBalExtendedBaseOpen              scBalBaseOpen
#define scBalExtendedBaseOrder             scBalBaseOrder
#define scBalExtendedBasePost              scBalBasePost
#define scBalExtendedBasePresents          scBalBasePresents
#define scBalExtendedBaseProcess           scBalBaseProcess
#define scBalExtendedBasePut               scBalBasePut
#define scBalExtendedBaseRead              scBalBaseRead
#define scBalExtendedBaseReadLock          scBalBaseReadLock
#define scBalExtendedBaseRecordClear       scBalBaseRecordClear
#define scBalExtendedBaseRecordGenerate    scBalBaseRecordGenerate
#define scBalExtendedBaseRevisionCancel    scBalBaseRevisionCancel
#define scBalExtendedBaseRevisionExists    scBalBaseRevisionExists
#define scBalExtendedBaseRevisionPost      scBalBaseRevisionPost
#define scBalExtendedBaseRevisionRekey     scBalBaseRevisionRekey
#define scBalExtendedBaseRevisionUnposted  scBalBaseRevisionUnposted
#define scBalExtendedBaseSecurity          scBalBaseSecurity
#define scBalExtendedBaseTableEmpty        scBalBaseTableEmpty
#define scBalExtendedBaseType              scBalBaseType
#define scBalExtendedBaseUnLock            scBalBaseUnLock
#define scBalExtendedBaseUpdate            scBalBaseUpdate
#define scBalExtendedBaseVerify            scBalBaseVerify

#else

VIEWCALL scBalBaseAttribs (LPVOID lpView, LONG lField, LPLONG lpAttributes)
{
   ERRNUM e = scBalExtendedBaseAttribs (lpView, lField, lpAttributes);
...
VIEWCALL scBalBaseBlkGet (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer)
{
   ERRNUM e = scBalExtendedBaseBlkGet (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer);
...
VIEWCALL scBalBaseBlkPut (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer, BOOL bVerify)
{
   ERRNUM e = scBalExtendedBaseBlkPut (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer, bVerify);
...
VIEWCALL scBalBaseBrowse (LPVOID lpView, LPSTR lpsExpression, BOOL bAscending)
{
   ERRNUM e = scBalExtendedBaseBrowse (lpView, lpsExpression, bAscending);
...
VIEWCALL scBalBaseCancel (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseCancel (lpView);
...
VIEWCALL scBalBaseClose (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseClose (lpView);
...
VIEWCALL scBalBaseCmpNames (INT roto, LPSTR lpsCompositeNames, LPSHORT lpnCount)
{
   ERRNUM e = scBalExtendedBaseCmpNames (roto, lpsCompositeNames, lpnCount);
...
VIEWCALL scBalBaseCompose (LPVOID lpView, LPVIEWDEF lpvdefComposites)
{
   ERRNUM e = scBalExtendedBaseCompose (lpView, lpvdefComposites);
...
VIEWCALL scBalBaseCreate (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scBalExtendedBaseCreate (hPIB, wLinkNo);
...
VIEWCALL scBalBaseDelete (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseDelete (lpView);
...
VIEWCALL scBalBaseDirty (LPVOID lpView, LPBOOL bChanged)
{
   ERRNUM e = scBalExtendedBaseDirty (lpView, bChanged);
...
VIEWCALL scBalBaseDrop (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scBalExtendedBaseDrop (hPIB, wLinkNo);
...
VIEWCALL scBalBaseExists (LPVOID lpView, LPBOOL bExists)
{
   ERRNUM e = scBalExtendedBaseExists (lpView, bExists);
...
VIEWCALL scBalBaseFetch (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseFetch (lpView);
...
VIEWCALL scBalBaseFetchLock (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseFetchLock (lpView);
...
VIEWCALL scBalBaseField (LPVOID lpView, INT nFldNumber, LPSTR lpsFldName, LPLONG lField)
{
   ERRNUM e = scBalExtendedBaseField (lpView, nFldNumber, lpsFldName, lField);
...
VIEWCALL scBalBaseFieldExists (LPV view, LONG lField, LP_A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseFieldExists (view, lField, flags);
...
VIEWCALL scBalBaseFieldName (LPV view, LONG lField, LPSTR lpsName, LPSTR lpsDesc, A4W_SIZE size)
{
   ERRNUM e = scBalExtendedBaseFieldName (view, lField, lpsName, lpsDesc, size);
...
VIEWCALL scBalBaseFields (LPVOID lpView, LPSHORT lFields)
{
   ERRNUM e = scBalExtendedBaseFields (lpView, lFields);
...
VIEWCALL scBalBaseFilterCount (LPV view, LPSTR filter, A4W_FLAGS flags, LP_A4W_SIZE count)
{
   ERRNUM e = scBalExtendedBaseFilterCount (view, filter, flags, count);
...
VIEWCALL scBalBaseFilterDelete (LPV view, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseFilterDelete (view, filter, flags);
...
VIEWCALL scBalBaseFilterFetch (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseFilterFetch (view, flags);
...
VIEWCALL scBalBaseFilterSelect (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseFilterSelect (view, key, filter, flags);
...
VIEWCALL scBalBaseGet (LPVOID lpView, LONG lField, LPSTR buffer, INT nSize)
{
   ERRNUM e = scBalExtendedBaseGet (lpView, lField, buffer, nSize);
...
VIEWCALL scBalBaseInit (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseInit (lpView);
...
VIEWCALL scBalBaseInsert (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseInsert (lpView);
...
VIEWCALL scBalBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = scBalExtendedBaseInstanceFieldList (view, flags, count, fields);
...
VIEWCALL scBalBaseInstanceNotify (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseInstanceNotify (view, notify, context, flags);
...
VIEWCALL scBalBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
   ERRNUM e = scBalExtendedBaseInstanceOpen (rvh, PIB, link, flags, extra, size, view);
...
VIEWCALL scBalBaseInstanceProtocol (LPV view, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = scBalExtendedBaseInstanceProtocol (view, flags, protocols, count);
...
VIEWCALL scBalBaseInstanceSecurity (LPV view, LP_A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseInstanceSecurity (view, flags);
...
VIEWCALL scBalBaseKey (LPVOID lpView, INT nKeyNo, LPSTR sName, LPSHORT lFields, LPLONG lplKeyFields)
{
   ERRNUM e = scBalExtendedBaseKey (lpView, nKeyNo, sName, lFields, lplKeyFields);
...
VIEWCALL scBalBaseKeys (LPVOID lpView, LPSHORT lpnKeys)
{
   ERRNUM e = scBalExtendedBaseKeys (lpView, lpnKeys);
...
VIEWCALL scBalBaseName (LPVOID lpView, LONG lField, LPSTR lpsName, LPSTR lpsDesc)
{
   ERRNUM e = scBalExtendedBaseName (lpView, lField, lpsName, lpsDesc);
...
VIEWCALL scBalBaseOpen (HPIB hPIB, WORD wLinkNo, LPVOID FAR * lpView)
{
   ERRNUM e = scBalExtendedBaseOpen (hPIB, wLinkNo, lpView);
...
VIEWCALL scBalBaseOrder (LPVOID lpView, INT nKey)
{
   ERRNUM e = scBalExtendedBaseOrder (lpView, nKey);
...
VIEWCALL scBalBasePost (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBasePost (lpView);
...
VIEWCALL scBalBasePresents (LPVOID lpView, LONG lField, LPSTR lpsMask, LPSHORT lpnList, LPSHORT lpnCount, LPVOID lpBuffer, INT nSize)
{
   ERRNUM e = scBalExtendedBasePresents (lpView, lField, lpsMask, lpnList, lpnCount, lpBuffer, nSize);
...
VIEWCALL scBalBaseProcess (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseProcess (lpView);
...
VIEWCALL scBalBasePut (LPVOID lpView, LONG lField, LPSTR lpsBuffer, INT nSize, BOOL bVerify)
{
   ERRNUM e = scBalExtendedBasePut (lpView, lField, lpsBuffer, nSize, bVerify);
...
VIEWCALL scBalBaseRead (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseRead (lpView);
...
VIEWCALL scBalBaseReadLock (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseReadLock (lpView);
...
VIEWCALL scBalBaseRecordClear (LPV view)
{
   ERRNUM e = scBalExtendedBaseRecordClear (view);
...
VIEWCALL scBalBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseRecordGenerate (view, flags);
...
VIEWCALL scBalBaseRevisionCancel (LPV view, INT level)
{
   ERRNUM e = scBalExtendedBaseRevisionCancel (view, level);
...
VIEWCALL scBalBaseRevisionExists (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseRevisionExists (view, level, flags);
...
VIEWCALL scBalBaseRevisionPost (LPV view, INT level)
{
   ERRNUM e = scBalExtendedBaseRevisionPost (view, level);
...
VIEWCALL scBalBaseRevisionRekey (LPV view, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseRevisionRekey (view, OldKey, NewKey, size, flags);
...
VIEWCALL scBalBaseRevisionUnposted (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scBalExtendedBaseRevisionUnposted (view, level, flags);
...
VIEWCALL scBalBaseSecurity (HPIB hPIB, WORD wLinkNo, LPLONG lplPermissions)
{
   ERRNUM e = scBalExtendedBaseSecurity (hPIB, wLinkNo, lplPermissions);
...
VIEWCALL scBalBaseTableEmpty (LPV view)
{
   ERRNUM e = scBalExtendedBaseTableEmpty (view);
...
VIEWCALL scBalBaseType (LPVOID lpView, LONG lField, LPTYPE lptype)
{
   ERRNUM e = scBalExtendedBaseType (lpView, lField, lptype);
...
VIEWCALL scBalBaseUnLock (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseUnLock (lpView);
...
VIEWCALL scBalBaseUpdate (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseUpdate (lpView);
...
VIEWCALL scBalBaseVerify (LPVOID lpView)
{
   ERRNUM e = scBalExtendedBaseVerify (lpView);
...
VIEWCALL rotoEntryBase (LPROTOVIEW v, INT length)
{
   ...
   switch ( v->op ) {
      case VIEW_OP_ATTRIBUTES :
         e = scBalAttribs (v->view, MapToNewFieldIndex (v->field), (LPLONG) v->p);
         break;
      case VIEW_OP_BLKGET :
         e = scBalBlkGet (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r);
         break;
      case VIEW_OP_BLKPUT :
         e = scBalBlkPut (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r, v->flag);
         break;
      case VIEW_OP_BROWSE :
         e = scBalBrowse (v->view, (LPSTR) v->p, v->flag);
         break;
      case VIEW_OP_CANCEL :
         e = scBalCancel (v->view);
         break;
      case VIEW_OP_CLOSE :
         e = scBalClose (v->view);
         break;
      case VIEW_OP_COMPOSE :
         e = scBalCompose (v->view, (LPVIEWDEF) v->p);
         break;
      case VIEW_OP_COMPOSITES :
         e = scBalCmpNames (v->i, (LPSTR) v->p, (LPSHORT) v->q);
         break;
      case VIEW_OP_CREATE :
         e = scBalCreate (v->i, v->x);
         break;
      case VIEW_OP_DELETE :
         e = scBalDelete (v->view);
         break;
      case VIEW_OP_DIRTY :
         e = scBalDirty (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_DROP :
         e = scBalDrop (v->i, v->x);
         break;
      case VIEW_OP_EXISTS :
         e = scBalExists (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_FETCH :
         e = scBalFetch (v->view);
         break;
      case VIEW_OP_FETCH_LOCK :
         e = scBalFetchLock (v->view);
         break;
      case VIEW_OP_FIELD :
         e = scBalField (v->view, v->i, (LPSTR) v->p, (LPLONG) v->q);
         break;
      case VIEW_OP_FIELD_EXISTS :
         e = scBalFieldExists ((LPV) v->view, v->field, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_FIELD_NAME :
         e = scBalFieldName ((LPV) v->view, v->field, (LPSTR) v->p, (LPSTR) v->q, v->i);
         break;
      case VIEW_OP_FIELDS :
         e = scBalFields (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_FILTER_COUNT :
         e = scBalFilterCount ((LPV) v->view, (LPSTR) v->p, v->dw, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_FILTER_DELETE :
         e = scBalFilterDelete ((LPV) v->view, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_FILTER_FETCH :
         e = scBalFilterFetch ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_FILTER_SELECT :
         e = scBalFilterSelect ((LPV) v->view, v->i, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_GET :
         e = scBalGet (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i);
         break;
      case VIEW_OP_INITIALIZE :
         e = scBalInit (v->view);
         break;
      case VIEW_OP_INSERT :
         e = scBalInsert (v->view);
         break;
      case VIEW_OP_INSTANCE_FIELDLIST :
         e = scBalInstanceFieldList ((LPV) v->view, v->dw, v->i, (PLONG) v->p);
         break;
      case VIEW_OP_INSTANCE_NOTIFY :
         e = scBalInstanceNotify ((LPV) v->view, (A4W_NOTIFY_PROC) v->p, v->q, v->dw);
         break;
      case VIEW_OP_INSTANCE_OPEN :
#if defined(DO_OPENETC) || !defined(DO_scBalOpen) || defined(DO_scBalInstanceOpen)
         e = scBalInstanceOpen ((LPRVH) v->p, v->i, v->x, v->dw,
                               v+1, length-sizeof (ROTOVIEW), (LPV *) &v->view);
#else
         e = scBalOpen (v->i, v->x, &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scBalInstanceOpen() is redirected to scBalOpen() because scBalOpen() is")
  #warning ("overridden, scBalInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #warning ("loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scBalInstanceOpen() is redirected to scBalOpen() because scBalOpen() is")
  #pragma message ("overridden, scBalInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #pragma message ("loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_INSTANCE_PROTOCOL :
         e = scBalInstanceProtocol ((LPV) v->view, v->dw, (LP_A4W_FLAGS) v->p, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_INSTANCE_SECURITY :
         e = scBalInstanceSecurity ((LPV) v->view, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_KEY :
         e = scBalKey (v->view, v->i, (LPSTR) v->p, (LPSHORT) v->q, (LPLONG) v->r);
         break;
      case VIEW_OP_KEYS :
         e = scBalKeys (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_NAME :
         e = scBalName (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, (LPSTR) v->q);
         break;
      case VIEW_OP_OPEN :
#if defined(DO_OPENETC) || defined(DO_scBalOpen) || !defined(DO_scBalInstanceOpen)
         e = scBalOpen (v->i, v->x, &v->view);
#else
         e = scBalInstanceOpen (NULL, v->i, v->x, 0L, NULL, 0, (LPV *) &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scBalOpen() is redirected to scBalInstanceOpen() because")
  #warning ("scBalInstanceOpen() is overridden, scBalOpen() isn't, and OpenEtc() isn't used.")
  #warning ("To avoid this loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scBalOpen() is redirected to scBalInstanceOpen() because")
  #pragma message ("scBalInstanceOpen() is overridden, scBalOpen() isn't, and OpenEtc() isn't used.")
  #pragma message ("To avoid this loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_ORDER :
         e = scBalOrder (v->view, v->i);
         break;
      case VIEW_OP_POST :
         e = scBalPost (v->view);
         break;
      case VIEW_OP_PRESENTATION :
         e = scBalPresents (v->view, MapToNewFieldIndex (v->field),
                           (LPSTR) v->p, (LPSHORT) v->q, (LPSHORT) v->r, v->s, v->i);
         break;
      case VIEW_OP_PROCESS :
         e = scBalProcess (v->view);
         break;
      case VIEW_OP_PUT :
         e = scBalPut (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i, v->flag);
         break;
      case VIEW_OP_READ :
         e = scBalRead (v->view);
         break;
      case VIEW_OP_READ_LOCK :
         e = scBalReadLock (v->view);
         break;
      case VIEW_OP_RECORD_CLEAR :
         e = scBalRecordClear ((LPV) v->view);
         break;
      case VIEW_OP_RECORD_GENERATE :
         e = scBalRecordGenerate ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_REVISION_CANCEL :
         e = scBalRevisionCancel ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_EXISTS :
         e = scBalRevisionExists ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_REVISION_POST :
         e = scBalRevisionPost ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_REKEY :
         e = scBalRevisionRekey ((LPV) v->view, v->p, v->q, v->i, v->dw);
         break;
      case VIEW_OP_REVISION_UNPOSTED :
         e = scBalRevisionUnposted ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_SECURITY :
         e = scBalSecurity (v->i, v->x, (LPLONG) v->p);
         break;
      case VIEW_OP_TABLE_EMPTY :
         e = scBalTableEmpty ((LPV) v->view);
         break;
//////////////////////////////////////////////////////////////////////////////
// Experimental stuff
      case VIEW_OP_TABLE_HANDLES :
         e = scBalTableHandles ((LPV) v->view, v->i, (LPWORD) v->p);
         break;
//////////////////////////////////////////////////////////////////////////////
      case VIEW_OP_TYPE :
         e = scBalType (v->view, MapToNewFieldIndex (v->field), (LPTYPE) v->p);
         break;
      case VIEW_OP_UNLOCK :
         e = scBalUnLock (v->view);
         break;
      case VIEW_OP_UPDATE :
         e = scBalUpdate (v->view);
         break;
      case VIEW_OP_VERIFY :
         e = scBalVerify (v->view);
         break;
      default :
...
VIEWCALL identifyEntry (LPIDENTIFYVIEW identify, INT length)
{
   switch ( identify->op ) {
      case IDENTIFY_OP_VERSION_TEMPLATE:
         return scBalVersionTemplate (identify->pib, identify->TextDatum, (LPBCDDATE) identify->BinaryDatum);
      case IDENTIFY_OP_VERSION_API:
         return scBalVersionAPI (identify->pib, identify->TextDatum);
      case IDENTIFY_OP_VIEW_NAME:
         return scBalViewName (identify->pib, identify->TextDatum, identify->TextLength);
      case IDENTIFY_OP_VIEW_TABLE_COUNT:
         return scBalViewTableCount (identify->pib, (LPSHORT) identify->BinaryDatum);
      case IDENTIFY_OP_VIEW_TABLES:
         return scBalViewTables (identify->pib, identify->TextDatum, identify->TextLength);
      default:
...
/*--------------------------------------------------------------------
   ...
   can change.
*/
VIEWCALL scBalExtendedBaseAttribs (
   LPVOID lpView,
   LONG nField,
...
/*--------------------------------------------------------------------
   ...
   can be used in place of several scBalGet calls to minimize the
   number of view calls.
*/
VIEWCALL scBalExtendedBaseBlkGet (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scBalGet (lpView, field, &lpsBuffer[nPos], size));
#else
...
/*--------------------------------------------------------------------
   ...
   of several scBalPut calls to minimize the number of view calls.
*/
VIEWCALL scBalExtendedBaseBlkPut (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scBalPut (lpView, field, &lpsBuffer[nPos], size, bVerify));
#else
      if ( ValidIndexV (lpv, field) ) {
         BASE_BLK_PUT();
         nPosSub = nPos + size;
...
/*--------------------------------------------------------------------
   ...
   and direction for subsequent scBalRead and scBalFetch calls. The
   key to start from is specified by the current contents of the
   logical record.
*/
VIEWCALL scBalExtendedBaseBrowse (
   LPVOID lpView,
   LPSTR lpsExpression,
   BOOL bAscending)
{
...
/*--------------------------------------------------------------------
   ...
   conjunction with scBalPost.
*/
VIEWCALL scBalExtendedBaseCancel (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   Closes an open view.
*/
VIEWCALL scBalExtendedBaseClose (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   INT nTbl;
...
/*--------------------------------------------------------------------
   ...
   compose. If lpsCompositeNames is a null address, scBalCmpNames will
   not return the list of view rotoIDS. Instead, scBalCmpNames will
   return the size of the buffer required to hold the sequence of
   character strings in *lpnCount.
*/
VIEWCALL scBalExtendedBaseCmpNames (
   INT roto,
...
*/
VIEWCALL scBalExtendedBaseCompose (
   LPVOID lpView,
...
*/
VIEWCALL scBalExtendedBaseCreate (
   HPIB hPIB,
   WORD wLinkNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scBalExtendedBaseDelete (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Reports whether fields have been altered with scBalPut calls.
*/
VIEWCALL scBalExtendedBaseDirty (
   LPVOID lpView,
   LPBOOL lpbChanged)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Deletes tables created by scBalCreate from the database denoted by
   wLinkNo. You should not currently be in a transaction when
   calling this function.
*/
VIEWCALL scBalExtendedBaseDrop (
   HPIB hPIB,
   WORD wLinkNo)
{
...
*/
VIEWCALL scBalExtendedBaseExists (
   LPVOID lpView,
   LPBOOL lpbExists)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   filter set in the last scBalBrowse call.
*/
VIEWCALL scBalExtendedBaseFetch (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Retrieves the next logical record according to the direction and
   filter set in the last scBalBrowse call. scBalFetchLock is the
   same as scBalFetch except that the record is locked.
*/
VIEWCALL scBalExtendedBaseFetchLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scBalExtendedBaseField (
   LPVOID lpView,
   INT nFldNumber,
   LPSTR lpsFldName,
   LPLONG lplField)
...
*/
VIEWCALL scBalExtendedBaseFieldExists (
   LPV view,
   LONG lField,
   LP_A4W_FLAGS flags)
{
...
*/
VIEWCALL scBalExtendedBaseFieldName (
   LPV view,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc,
...
*/
VIEWCALL scBalExtendedBaseFields (
   LPVOID lpView,
   LPSHORT lpnFields)
{
   if ( SUBCLASS_LEVEL==NOT_SUBCLASS ) {
...
VIEWCALL scBalExtendedBaseFilterCount (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags,
   LP_A4W_SIZE count)
{
   ...
   if ( expression==NULL ) {
      ...
      f = filterExprSegments (lpv, &lpv->filter, lpv->wDetailFilterSegments,
                              (FILTERNAME) xxxNameOnly, (FILTERGET) scBalGet, &range);
      RVSPYTRACE (range);
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, range, &filter, (FILTERFIELD) scBalField, (FILTERFIELDS) scBalFields, (FILTERTYPE) scBalType);
...
*/
VIEWCALL scBalExtendedBaseFilterDelete (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags)
{
...
VIEWCALL scBalExtendedBaseFilterFetch       (LPV lpv, A4W_FLAGS flags)
{
...
VIEWCALL scBalExtendedBaseFilterSelect     (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   ...
   CHECK_CALL (e, scBalOrder (view, key));
   CHECK_CALL (e, scBalBrowse (view, filter, ascending));
   return e;
}
   ...
   INT nSize)
{
   ...
   if ( lField==DIRTY_IDX ) {
      ...
      CHECK_CALL (e, scBalRevisionUnposted (lpv, 1+HDR_HAS_REVISIONS, &flags));
...
/*--------------------------------------------------------------------
   ...
   field in a view.
*/
VIEWCALL scBalExtendedBaseInit (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   record is not added.
*/
VIEWCALL scBalExtendedBaseInsert (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==SEQUENCE_REVISIONS && GENERATEKEY_NONE==lpv->bKeyGenerated ) {
      ...
      // of its details, the key must have been generated via scBalRecordGenerate()
      int c;
...
VIEWCALL scBalExtendedBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseInstanceNotify   (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
...
VIEWCALL scBalExtendedBaseInstanceProtocol (LPV lpv, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseInstanceSecurity (LPV lpv, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   conjunction with scBalKey to retrieve information about key
   structure.
*/
VIEWCALL scBalExtendedBaseKeys (
   LPVOID lpView,
   LPSHORT lpnKeys)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scBalExtendedBaseName (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc)
...
*/
VIEWCALL scBalExtendedBaseOpen (
   HPIB hPIB,
   WORD wLinkNo,
   LPVOID FAR * lplpView)
{
...
*/
VIEWCALL scBalExtendedBaseOrder (
   LPVOID lpView,
   INT nKeyNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scBalExtendedBasePost (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scBalPost is no longer supported on non-revisioned views.");
   }
#endif
...
*/
VIEWCALL scBalExtendedBasePresents (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsMask,
   LPSHORT lpnList,
...
*/
VIEWCALL scBalExtendedBaseProcess (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
   ...
   if ( (* comparator) (f, (LPDATUM) target, (LPDATUM) normalized)!=0 ) {
      ...
      if ( attribs & ATTR_KEY ) {
         ...
         blkSet ((FindRecord (lpv)) [BASE_TBL_COUNT] +
                  FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCBAL_FLD_AUDIT].wOffset,
                 ' ', sizeof (AUDITSTAMP));
#endif
         if ( SUBCLASS_LEVEL!=NOT_SUBCLASS ) {
            CHECK_CALL (e, BaseBrowse (lpv, FALSE));
...
*/
VIEWCALL scBalExtendedBaseRead (
   LPVOID lpView)
{
...
/*--------------------------------------------------------------------
   Fetches the logical record index by the current contents of the
   view's key fields. If there are composite views, the caller is
   responsible for reading them in as well. scBalReadLock is the
   same as scBalRead except that the record is locked.
*/
VIEWCALL scBalExtendedBaseReadLock (
   LPVOID lpView)
{
...
VIEWCALL scBalExtendedBaseRecordClear (LPV view)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseRevisionCancel   (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseRevisionExists   (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
...
VIEWCALL scBalExtendedBaseRevisionPost     (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
   REV_ERRNUM r = POST_DONE;
...
#if !(defined(DETAIL_VIEW) || defined(SUPER_VIEW))
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scBalRevisionPost is no longer supported on non-revisioned views.");
   }
#endif
...
VIEWCALL scBalExtendedBaseRevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalExtendedBaseRevisionUnposted (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   BOOL dirty = FALSE;
...
/*--------------------------------------------------------------------
   ...
   given database link.
*/
VIEWCALL scBalExtendedBaseSecurity (
   HPIB hPIB,
   WORD wLinkNo,
...
*/
VIEWCALL scBalExtendedBaseTableEmpty (LPV lpv)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   varies by type.
*/
VIEWCALL scBalExtendedBaseType (
   LPVOID lpView,
   LONG nField,
   LPTYPE lptype)
{
...
/*--------------------------------------------------------------------
   Unlocks the logical record locked by the scBalFetchLock or the
   scBalReadLock calls.
*/
VIEWCALL scBalExtendedBaseUnLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   ...
   been altered; if they are use the scBalInsert routine instead.
*/
VIEWCALL scBalExtendedBaseUpdate (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scBalExtendedBaseVerify (
   LPVOID lpView)
{
...
VIEWBASE xxxFetchFilterBase (LPV lpv, INT flags, LPFILTER filter, LPSHORT range, BOOL ascending)
{
   ...
   if ( !started ) {
      ...
      f = filterInitRange (lpv, filter, ascending, range,
                           (FILTERGET) scBalGet, (FILTERPUT) scBalPut);
   ...
   for (;;) {
      ...
      switch ( d ) {
         ...
         case DBS_CVIEW_WARNING:
            ...
            f = filterEval (lpv, (FILTERGET) scBalGet, filter, ascending, *range);
            switch ( f ) {
               case FL_SUCCESS:
                  goto RecordFound;
               case FL_FAIL:
      ...
      if ( f==FL_END_OF_RANGE || d==DBS_NO_MORE_DATA ) {
         ...
         f = filterPutRange (lpv, filter, ascending, *range, (FILTERPUT) scBalPut);
         if ( FL_ERRNUM_IS_FAILURE (f) )
            goto ReturnFilterError;
         if ( DB_ERRNUM_IS_FAILURE (d) )
            d = DBS_SUCCESS;
...
VIEWCALL xxxKey (
   ...
   LPSHORT lpnFields,
   LPLONG lplKeyFields)
// Call gate for scBalKey, intended for use by the filter* routines.
// It Suppresses reporting of boundary errors, though others may be reported.
{
   ...
   *lpnFields = 0;
   ...
   MaxError (&e, scBalKey (lpView, nKeyNo, lpsName, lpnFields, lplKeyFields));
   return e;
}
...
#define VALIDATE(__expr__) {          \
   ...
   if ( lpv->bVerified ) {
      ...
      CHECK_CALL_GOTO (e, protocol_error, scBalDirty (lpView, &dirty));
#endif
      if ( !dirty )
          return ERRNUM_SUCCESS;
   }
   ...
   if ( SUBCLASS_LEVEL!=NOT_SUBCLASS && verifying && VIEW_OP (lpv, OPEN)==VIEW_OP_VERIFY ) {
      // Only propagate verification if scBalVerify really was called
...
VIEWBASE BrowseBody (LPV lpv, LPSTR expression, BOOL ascending)
{
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, expression, &lpv->filter, (FILTERFIELD) scBalField,
                    (FILTERFIELDS) scBalFields, (FILTERTYPE) scBalType);
   CHECK_CALL (e, ErrorMapFilterToExtended (op, filterErrorV (lpv, op, f)));
...
// scBalFilterDelete(), along with all its limitations. In particular,
   ...
   INT nSize)
{
   ...
   if ( nSize!=sizeof(etag) )
   {
      ReportError (lpv, (RSCID)IDERR_SC_BUFFER_MSG,
                   MAKERSC(IDS_SCBAL_VIEW_NOUN), "ETAG", NULL);
      return ERRNUM_MEMORY_BUFFER_LIMIT;
   }
   ...
   if ( HAS_DATABASE_TABLES )
   {
      ...
      lpadt = (LPAUDITSTAMP) (FindRecord (lpv) [BASE_TBL_COUNT] +
                              FindTableMap (BASE_TBL_COUNT)->fields[SCBAL_FLD_AUDIT].wOffset);
   }
   else
   {
      DBDATE dbDate;
...
VIEWBASE GenerateKeyReally (LPV lpv)
{
   ...
   INT primary = FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCBAL_FLD_AUDIT].wOffset;
...
A4W_FLAGS WINAPI GetPermissions (LPV lpv)
{
   ...
   e = scBalInstanceSecurity (lpv, &permissions);
   if ( ERRNUM_IS_FAILURE (e) )
      permissions = 0;
   return permissions;
}
...
// This function should NEVER be called from scBalPost or scBalCancel entrypoints
...
VIEWBASE NotifyClose (LPV lpv)
{
   ...
   for ( c=0; c<EXP_CMP_COUNT; ++c ) {
      ...
      if ( (d && (d->options & CMPNAME_OPTION_NOTIFY)) ||
         ...
         // scBalClose, so we have to try to clear away everything.
      }
   }
...
#if defined(SCBAL_ROTOID)
   utlObjStrToID (SCBAL_ROTOID, &lpv->rotoID);
#endif
      ...
      switch ( e ) {
         ...
         case ERRNUM_OPEN_FAILED:
            ReportError (lpv, (RSCID)IDERR_SC_VIEWOPEN_MSG,
                         MAKERSC(IDS_SCBAL_VIEW_NOUN), NULL, NULL);
            break;
...
#define REPORT_USE_ERROR(v,e,f) \
   ReportError ((v), (RSCID)(e), MAKERSC(IDS_SCBAL_VIEW_NOUN), \
...
void WINAPI ReportBaseLoadError (HPIB hpib, LPSTR rotoID)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_VIEWLOAD_MSG,
                      MAKERSC(IDS_SCBAL_VIEW_NOUN), rotoID, NULL);
}
...
void WINAPI ReportBaseMemoryError (HPIB hpib, RSCID op)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_MEMORY_MSG,
                      MAKERSC(IDS_SCBAL_VIEW_NOUN), MAKERSC(op), NULL);
}
...
void WINAPI ReportCompositeKeyError (LPV lpv, RSCID op, LPSTR rotoID)
{
   ReportError (lpv, (RSCID)IDERR_SC_CMPKEY_MSG,
                MAKERSC(IDS_SCBAL_VIEW_NOUN), MAKERSC(op), rotoID);
}
...
void WINAPI ReportFieldError (LPV lpv, INT field)
{
   ...
   ReportError (lpv, (RSCID)IDERR_SC_FLDNUM_MSG,
                MAKERSC(IDS_SCBAL_VIEW_NOUN), value, NULL);
}
...
{
   errPutGeneric (lpv->hpib, APPL, MAKERSC (IDS_SCBAL_VIEW_NOUN), NULL,
...
{
   errPutGeneric (pib, APPL, MAKERSC(IDS_SCBAL_VIEW_NOUN), NULL,
                  area, op, MAKERSC (ERRGEN_CAT_DEFAULT), error, extra);
}
...
void WINAPI ReportString (LPSTR message)
{
   ...
   buffer[0] = 0;
#if defined(SCBAL_ROTOID)
   strCopy (buffer, SCBAL_ROTOID);
   strAppend (buffer, ": ");
#endif
   strAppend (buffer, "<SCBAL> ");
...
void WINAPI ScratchError (LPV lpv)
{
   ...
   rscLoadText (lpv->hpib, APPL, IDS_SCBAL_VIEW_NOUN, noun, sizeof (noun));
...
DB_ERRNUM WINAPI RevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ...
   primary = FindTableMapV (lpv, i)->fields[SCBAL_FLD_AUDIT].wOffset;
   if ( HDR_HAS_REVISIONS==0 )
      // Note: this only works for MP3 records
      iHdrPKeySize = (INT) FindTableMapV (lpv, i)->fields[SCBAL_FLD_AUDIT - DTL_SEG_COUNT].wOffset;
   else
 ...
 * I/O, copy these corresponding functions out of the scBal.C file replacing *
...
DB_ERRNUM WINAPI fileAddBase (WORD wLinkNo, HPIB hpib)
{
   ...
   MaxDatabaseError (&d, ErrorMapViewToDatabase (VIEW_OP_OPEN,
                                                 scBalOpen (hpib, wLinkNo, (LPVOID *) &lpv)));
   if ( DB_ERRNUM_IS_SUCCESS (d) ) {
      ...
      if ( !lpv->bRevisioned ) {
         ...
         if ( lpv->bReadOnly ) {
            ...
            FL_ERRNUM f = filterExprFirst (lpv, &lpv->filter,
               (FILTERNAME) xxxNameOnly, (FILTERGET) scBalGet, lpv->bAhead, &first);
            ...
            if ( DB_ERRNUM_IS_SUCCESS (d) ) {
               ...
               f = filterExprSegments (lpv, &lpv->filter, nSegs,
                  (FILTERNAME) xxxNameOnly, (FILTERGET) scBalGet, &detail);
               RVSPYTRACE (detail);
               filterErrorV (lpv, op, f);
               MaxDatabaseError (&d, ErrorMapFilterToDatabase (op, f));
               if ( DB_ERRNUM_IS_SUCCESS (d) ) {
...
{
   DB_ERRNUM d = DBS_SUCCESS;
   CHAR array[SIZEOF_TABLENAME] = {'S','C','B','A','L',' ',' ',' '};
   LPSTR name = array;
      ...
      for ( i=BASE_TBL_COUNT; i<BASE_TBL_COUNT+TBL_COUNT; i++ ) {
         ...
         if ( DB_ERRNUM_IS_SUCCESS (d) ) {
            ...
            if ( DBS_DD_INCONSISTENT==d ||
               ...
               // in all subsequent scBalInstanceFieldList() calls
            }
         }
         if ( DB_ERRNUM_IS_FAILURE (d) ) {
            while ( --i>=BASE_TBL_COUNT )
...
*/
VIEWCALL scBalTableHandles (LPV lpv, INT count, LPWORD handles)
{
   ERRNUM e = ERRNUM_SUCCESS;
   INT i;
   SHORT baseTables = 0;
...
VIEWCALL scBalVersionTemplate (INT roto, LPSTR version, LPBCDDATE date)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalVersionAPI (INT roto, LPSTR version)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalViewName (HPIB pib, LPSTR name, INT size)
{
   rscLoadText (pib, APPL, IDS_SCBAL_VIEW_NAME, name, size);
   return ERRNUM_SUCCESS;
}



VIEWCALL scBalViewTableCount (INT roto, LPSHORT tableCount)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scBalViewTables (INT roto, LPSTR tableNames, INT size)
{
   INT i;
   SHORT baseTables = 0;
   ERRNUM e = ERRNUM_SUCCESS;
