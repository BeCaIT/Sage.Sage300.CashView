...
// section in scOpt1.c, and using -DSTUB_VIEW on the compiler command line
...
// pass them explicitly via scOptCompose, in which case they will be loaded
...
#define SCOPT_FLD_AUDIT        SCOPT_FLD(AUDTDATE)
//#define SCOPT2_FLD_AUDIT       SCOPT2_FLD(AUDTDATE)


// Number of field indexes published from the view
//#define FLD_IDX_COUNT    (SCOPT_IDX_COUNT)
// if multiple tables are used uncomment the following define in place of the above
#define FLD_IDX_COUNT    (SCOPT_IDX_COUNT + SCOPT2_IDX_COUNT)

// Highest-valued field index + 1 for C-style array dimensioning
#define FLD_IDX_LIMIT    (1+SCOPT_IDX(PROCESSCMD))
...
// Remove comment as required. See scOpt1.c file for comments on usage of each
...
// The original semantics are available by calling scOptBaseYYYY()
//#define DO_scOptAttribs             1
//#define DO_scOptBlkGet              1
//#define DO_scOptBlkPut              1
//#define DO_scOptBrowse              1
//#define DO_scOptCancel              1
//#define DO_scOptClose               1
//#define DO_scOptCmpNames            1
//#define DO_scOptCompose             1
//#define DO_scOptCreate              1
//#define DO_scOptDelete              1
//#define DO_scOptDirty               1
//#define DO_scOptDrop                1
//#define DO_scOptExists              1
//#define DO_scOptFetch               1
//#define DO_scOptFetchLock           1
//#define DO_scOptField               1
//#define DO_scOptFieldExists         1
//#define DO_scOptFieldName           1
//#define DO_scOptFields              1
//#define DO_scOptFilterDelete        1
//#define DO_scOptFilterFetch         1
//#define DO_scOptFilterSelect        1
//#define DO_scOptGet                 1
//#define DO_scOptInit                1
//#define DO_scOptInsert              1
//#define DO_scOptInstanceFieldList   1
//#define DO_scOptInstanceNotify      1
//#define DO_scOptInstanceOpen        1
//#define DO_scOptInstanceProtocol    1
//#define DO_scOptInstanceSecurity    1
//#define DO_scOptKey                 1
//#define DO_scOptKeys                1
//#define DO_scOptName                1
//#define DO_scOptOpen                1
//#define DO_scOptOrder               1
//#define DO_scOptPost                1
//#define DO_scOptPresents            1
//#define DO_scOptProcess             1
//#define DO_scOptPut                 1
//#define DO_scOptRead                1
//#define DO_scOptReadLock            1
//#define DO_scOptRecordClear         1
//#define DO_scOptRecordGenerate      1
//#define DO_scOptRevisionCancel      1
//#define DO_scOptRevisionExists      1
//#define DO_scOptRevisionPost        1
//#define DO_scOptRevisionRekey       1
//#define DO_scOptRevisionUnposted    1
//#define DO_scOptSecurity            1
//#define DO_scOptTableEmpty          1
//#define DO_scOptType                1
//#define DO_scOptUnLock              1
#define DO_scOptUpdate              1
//#define DO_scOptVerify              1
