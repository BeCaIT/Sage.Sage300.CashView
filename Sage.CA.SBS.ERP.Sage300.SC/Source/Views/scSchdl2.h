...
#if !defined(__scSchdl2_h)
// Ensures header is only included once.
#define __scSchdl2_h        1
...
#if TEMPLATE_WARNING_LEVEL<=0 && !defined(SCSCHDL_ROTOID)
 #if defined LINUX_VER
  #warning ("The template disables some features when SCSCHDL_ROTOID has been removed")
  #warning ("from scSchdl.h. Please define it to activate these features")
 #else
  #pragma message ("The template disables some features when SCSCHDL_ROTOID has been removed")
  #pragma message ("from scSchdl.h. Please define it to activate these features")
 #endif
#endif

#if TEMPLATE_WARNING_LEVEL<=1 && !defined(DO_XXXFETCHFILTER) && (defined(DO_scSchdlFetch) || defined(DO_scSchdlFetchLock) || defined(DO_scSchdlFilterFetch))
 #if defined LINUX_VER
  #warning ("Consider overriding xxxFetchFilter if you have previously overridden any of")
  #warning ("scSchdlFetch, scSchdlFetchLock or scSchdlFilterFetch")
 #else
  #pragma message ("Consider overriding xxxFetchFilter if you have previously overridden any of")
  #pragma message ("scSchdlFetch, scSchdlFetchLock or scSchdlFilterFetch")
 #endif
#endif

#if TEMPLATE_WARNING_LEVEL<=1 && !defined(DO_XXXREAD) && (defined(DO_scSchdlRead) || defined(DO_scSchdlReadLock))
 #if defined LINUX_VER
  #warning ("Consider overriding xxxRead if you have previously overridden any of")
  #warning ("scSchdlRead or scSchdlReadLock")
 #else
  #pragma message ("Consider overriding xxxRead if you have previously overridden any of")
  #pragma message ("scSchdlRead or scSchdlReadLock")
 #endif
#endif

#if TEMPLATE_WARNING_LEVEL<=1 && !defined(DO_INITBODYGEN) && (defined(DO_scSchdlInit) || defined(DO_scSchdlRecordClear) || defined(DO_scSchdlRecordGenerate))
 #if defined LINUX_VER
  #warning ("Consider overriding InitBodyGen if you have previously overridden any of")
  #warning ("scSchdlInit, scSchdlRecordClear or scSchdlRecordGenerate")
 #else
  #pragma message ("Consider overriding InitBodyGen if you have previously overridden any of")
  #pragma message ("scSchdlInit, scSchdlRecordClear or scSchdlRecordGenerate")
 #endif
#endif

#if TEMPLATE_WARNING_LEVEL<=1 && (!defined(DO_DELETEBODY) && !defined(DO_DELETEDETAILSBODY)) && (defined(DO_scSchdlDelete) || defined(DO_scSchdlFilterDelete))
 #if defined LINUX_VER
  #warning ("Consider overriding either DeleteBody or DeleteDetailsBody if you have previously")
  #warning ("overridden any of scSchdlDelete or scSchdlFilterDelete")
 #else
  #pragma message ("Consider overriding either DeleteBody or DeleteDetailsBody if you have previously")
  #pragma message ("overridden any of scSchdlDelete or scSchdlFilterDelete")
 #endif
#endif

#if TEMPLATE_WARNING_LEVEL<=0 && ((defined(DO_scSchdlSecurity) && !defined(DO_scSchdlInstanceSecurity)) || (!defined(DO_scSchdlSecurity) && defined(DO_scSchdlInstanceSecurity)))
 #if defined LINUX_VER
  #warning ("If either of scSchdlSecurity or scSchdlInstanceSecurity is overridden")
  #warning ("you should override the other")
 #else
  #pragma message ("If either of scSchdlSecurity or scSchdlInstanceSecurity is overridden")
...
// These used to be optional, now are required.
 ...
 #error DO_OLDPOST is no longer supported for non-revisioned views, and results in scSchdlBasePost doing nothing. You need to remove it, plus change any callers that depended on this behaviour.
#endif
 ...
 #error DO_GETPERMISSIONS is no longer supported. You must override scSchdlInstanceSecurity instead.
#endif
...
// The following provide simple error checking by view protocol
 ...
 #error View protocol must be explicitly selected
  ...
  #elif KEY_COUNT!=(SCSCHDL_KEY_COUNT-JOIN_KEY_COUNT+FAKE_KEY_COUNT)
   #error KEY_COUNT must be defined as (SCSCHDL_KEY_COUNT-JOIN_KEY_COUNT+FAKE_KEY_COUNT)
  #endif
  ...
  #error Under C++ you must derive VEXTRA in scSchdl3.h from VBASE
 #endif
...
struct tagV {
   ...
   BOOL bVerifying; // inside scSchdlVerify routine
   ...
   WORD wKey; // Current key as passed to scSchdlOrder
   ...
   LPVOID OpenExtra; // copy of extra data received by scSchdlInstanceOpen
   ...
   LONG rotoID; // My own rotoID; needs SCSCHDL_ROTOID to be defined to be meaningful
...
#if !defined(__cplusplus)
 #if defined(DO_VIEWHANDLE)
   VEXTRA extra; // Programmer-defined view handle extensions, defined in scSchdl1.h
 #endif
...
// definition in the scSchdl1.c file must be done.
...
// initialized in the scSchdl1.c file.
...
/////////////////////////////////////////////////////////////////////////////
// Declarations for generally available subroutines found in scSchdl.c

// The fileXXXX routines are not always defined by the template. For stub
// views they appear in scSchdl1.c, and must be specified by the programmer.
...
VIEWCALL scSchdlFieldExists       (LPV view, LONG field, LP_A4W_FLAGS flags);
VIEWCALL scSchdlFieldName         (LPV view, LONG field, LPSTR name, LPSTR desc, A4W_SIZE size);
VIEWCALL scSchdlFields            (LPVOID lpView, LPSHORT lFields);
VIEWCALL scSchdlFilterCount       (LPV view, LPSTR filter, A4W_FLAGS flags, LP_A4W_SIZE count);
...
VIEWCALL scSchdlInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields);
VIEWCALL scSchdlInstanceNotify    (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags);
VIEWCALL scSchdlInstanceOpen      (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view);
...
VIEWCALL scSchdlOpen              (HPIB hPIB, WORD wLinkNo, LPVOID FAR * lpView);
...
VIEWCALL scSchdlRevisionRekey     (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags);
...
VIEWCALL scSchdlViewTableCount    (INT roto, LPSHORT tables);
VIEWCALL scSchdlViewTables        (INT roto, LPSTR tables, INT size);
...
VIEWCALL scSchdlBaseFieldExists       (LPV view, LONG field, LP_A4W_FLAGS flags);
VIEWCALL scSchdlBaseFieldName         (LPV view, LONG field, LPSTR name, LPSTR desc, A4W_SIZE size);
...
VIEWCALL scSchdlBaseRevisionRekey     (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags);
...
VIEWCALL scSchdlExtendedBaseAttribs           (LPVOID lpView, LONG lField, LPLONG lpAttributes);
VIEWCALL scSchdlExtendedBaseBlkGet            (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer);
VIEWCALL scSchdlExtendedBaseBlkPut            (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer, BOOL bVerify);
VIEWCALL scSchdlExtendedBaseBrowse            (LPVOID lpView, LPSTR lpsExpression, BOOL bAscending);
VIEWCALL scSchdlExtendedBaseCancel            (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseClose             (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseCmpNames          (INT roto, LPSTR lpsCompositeNames, LPSHORT lpnCount);
VIEWCALL scSchdlExtendedBaseCompose           (LPVOID lpView, LPVIEWDEF lpvdefComposites);
VIEWCALL scSchdlExtendedBaseCreate            (HPIB hPIB, WORD wLinkNo);
VIEWCALL scSchdlExtendedBaseDelete            (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseDirty             (LPVOID lpView, LPBOOL bChanged);
VIEWCALL scSchdlExtendedBaseDrop              (HPIB hPIB, WORD wLinkNo);
VIEWCALL scSchdlExtendedBaseExists            (LPVOID lpView, LPBOOL bExists);
VIEWCALL scSchdlExtendedBaseFetch             (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseFetchLock         (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseField             (LPVOID lpView, INT nFldNumber, LPSTR lpsFldName, LPLONG lField);
VIEWCALL scSchdlExtendedBaseFieldExists       (LPV view, LONG field, LP_A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseFieldName         (LPV view, LONG field, LPSTR name, LPSTR desc, A4W_SIZE size);
VIEWCALL scSchdlExtendedBaseFields            (LPVOID lpView, LPSHORT lFields);
VIEWCALL scSchdlExtendedBaseFilterCount       (LPV view, LPSTR filter, A4W_FLAGS flags, LP_A4W_SIZE count);
VIEWCALL scSchdlExtendedBaseFilterDelete      (LPV view, LPSTR filter, A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseFilterFetch       (LPV view, A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseFilterSelect      (LPV view, INT key, LPSTR filter, A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseGet               (LPVOID lpView, LONG lField, LPSTR buffer, INT nSize);
VIEWCALL scSchdlExtendedBaseInit              (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseInsert            (LPVOID lpView);
...
VIEWCALL scSchdlExtendedBaseInstanceProtocol  (LPV view, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count);
VIEWCALL scSchdlExtendedBaseInstanceSecurity  (LPV view, LP_A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseKey               (LPVOID lpView, INT nKeyNo, LPSTR sName, LPSHORT lFields, LPLONG lplKeyFields);
VIEWCALL scSchdlExtendedBaseKeys              (LPVOID lpView, LPSHORT lpnKeys);
VIEWCALL scSchdlExtendedBaseName              (LPVOID lpView, LONG lField, LPSTR lpsName, LPSTR lpsDesc);
VIEWCALL scSchdlExtendedBaseOpen              (HPIB hPIB, WORD wLinkNo, LPVOID FAR * lpView);
VIEWCALL scSchdlExtendedBaseOrder             (LPVOID lpView, INT nKey);
VIEWCALL scSchdlExtendedBasePost              (LPVOID lpView);
VIEWCALL scSchdlExtendedBasePresents          (LPVOID lpView, LONG lField, LPSTR lpsMask, LPSHORT lpnList, LPSHORT lpnCount, LPVOID lpBuffer, INT nSize);
VIEWCALL scSchdlExtendedBaseProcess           (LPVOID lpView);
VIEWCALL scSchdlExtendedBasePut               (LPVOID lpView, LONG lField, LPSTR lpsBuffer, INT nSize, BOOL bVerify);
VIEWCALL scSchdlExtendedBaseRead              (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseReadLock          (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseRecordClear       (LPV view);
VIEWCALL scSchdlExtendedBaseRecordGenerate    (LPV view, A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseRevisionCancel    (LPV view, INT level);
VIEWCALL scSchdlExtendedBaseRevisionExists    (LPV view, INT level, LP_A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseRevisionPost      (LPV view, INT level);
VIEWCALL scSchdlExtendedBaseRevisionRekey     (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseRevisionUnposted  (LPV view, INT level, LP_A4W_FLAGS flags);
VIEWCALL scSchdlExtendedBaseSecurity          (HPIB hPIB, WORD wLinkNo, LPLONG lplPermissions);
VIEWCALL scSchdlExtendedBaseTableEmpty        (LPV view);
VIEWCALL scSchdlExtendedBaseType              (LPVOID lpView, LONG lField, LPTYPE lptype);
VIEWCALL scSchdlExtendedBaseUnLock            (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseUpdate            (LPVOID lpView);
VIEWCALL scSchdlExtendedBaseVerify            (LPVOID lpView);
...
VIEWCALL viewOldVerify            (LPVOID rvh, LPVOID view);
 ...
 #if defined(__scSchdl_c) || DO_EXTENDEDERRORS>NO_EXTENDEDERRORS
