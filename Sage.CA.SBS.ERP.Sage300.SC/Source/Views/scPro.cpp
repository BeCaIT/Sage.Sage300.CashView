...
#if !defined(DO_scProAttribs)
 #define scProBaseAttribs         scProAttribs
#endif

#if !defined(DO_scProBlkGet)
 #define scProBaseBlkGet          scProBlkGet
#endif

#if !defined(DO_scProBlkPut)
 #define scProBaseBlkPut          scProBlkPut
#endif

#if !defined(DO_scProBrowse)
 #define scProBaseBrowse          scProBrowse
#endif

#if !defined(DO_scProCancel)
 #define scProBaseCancel          scProCancel
#endif

#if !defined(DO_scProClose)
 #define scProBaseClose           scProClose
#endif

#if !defined(DO_scProCmpNames)
 #define scProBaseCmpNames        scProCmpNames
#endif

#if !defined(DO_scProCompose)
 #define scProBaseCompose         scProCompose
#endif

#if !defined(DO_scProCreate)
 #define scProBaseCreate          scProCreate
#endif

#if !defined(DO_scProDelete)
 #define scProBaseDelete          scProDelete
#endif

#if !defined(DO_scProDirty)
 #define scProBaseDirty           scProDirty
#endif

#if !defined(DO_scProDrop)
 #define scProBaseDrop            scProDrop
#endif

#if !defined(DO_scProExists)
 #define scProBaseExists          scProExists
#endif

#if !defined(DO_scProFetch)
 #define scProBaseFetch           scProFetch
#endif

#if !defined(DO_scProFetchLock)
 #define scProBaseFetchLock       scProFetchLock
#endif

#if !defined(DO_scProField)
 #define scProBaseField           scProField
#endif

#if !defined(DO_scProFieldExists)
 #define scProBaseFieldExists     scProFieldExists
#endif

#if !defined(DO_scProFieldName)
 #define scProBaseFieldName       scProFieldName
#endif

#if !defined(DO_scProFields)
 #define scProBaseFields          scProFields
#endif

#if !defined(DO_scProFilterCount)
 #define scProBaseFilterCount     scProFilterCount
#endif

#if !defined(DO_scProFilterDelete)
 #define scProBaseFilterDelete    scProFilterDelete
#endif

#if !defined(DO_scProFilterFetch)
 #define scProBaseFilterFetch     scProFilterFetch
#endif

#if !defined(DO_scProFilterSelect)
 #define scProBaseFilterSelect    scProFilterSelect
#endif

#if !defined(DO_scProGet)
 #define scProBaseGet             scProGet
#endif

#if !defined(DO_scProInit)
 #define scProBaseInit            scProInit
#endif

#if !defined(DO_scProInsert)
 #define scProBaseInsert          scProInsert
#endif

#if !defined(DO_scProInstanceFieldList)
 #define scProBaseInstanceFieldList  scProInstanceFieldList
#endif

#if !defined(DO_scProInstanceNotify)
 #define scProBaseInstanceNotify  scProInstanceNotify
#endif

#if !defined(DO_scProInstanceOpen)
 #define scProBaseInstanceOpen    scProInstanceOpen
#endif

#if !defined(DO_scProInstanceProtocol)
 #define scProBaseInstanceProtocol scProInstanceProtocol
#endif

#if !defined(DO_scProInstanceSecurity)
 #define scProBaseInstanceSecurity scProInstanceSecurity
#endif

#if !defined(DO_scProKey)
 #define scProBaseKey             scProKey
#endif

#if !defined(DO_scProKeys)
 #define scProBaseKeys            scProKeys
#endif

#if !defined(DO_scProName)
 #define scProBaseName            scProName
#endif

#if !defined(DO_scProOpen)
 #define scProBaseOpen            scProOpen
#endif

#if !defined(DO_scProOrder)
 #define scProBaseOrder           scProOrder
#endif

#if !defined(DO_scProPost)
 #define scProBasePost            scProPost
#endif

#if !defined(DO_scProPresents)
 #define scProBasePresents        scProPresents
#endif

#if !defined(DO_scProProcess)
 #define scProBaseProcess         scProProcess
#endif

#if !defined(DO_scProPut)
 #define scProBasePut             scProPut
#endif

#if !defined(DO_scProRead)
 #define scProBaseRead            scProRead
#endif

#if !defined(DO_scProReadLock)
 #define scProBaseReadLock        scProReadLock
#endif

#if !defined(DO_scProRecordClear)
  #define scProBaseRecordClear    scProRecordClear
#endif

#if !defined(DO_scProRecordGenerate)
  #define scProBaseRecordGenerate scProRecordGenerate
#endif

#if !defined(DO_scProRevisionCancel)
 #define scProBaseRevisionCancel  scProRevisionCancel
#endif

#if !defined(DO_scProRevisionExists)
 #define scProBaseRevisionExists  scProRevisionExists
#endif

#if !defined(DO_scProRevisionPost)
 #define scProBaseRevisionPost    scProRevisionPost
#endif

#if !defined(DO_scProRevisionRekey)
 #define scProBaseRevisionRekey   scProRevisionRekey
#endif

#if !defined(DO_scProRevisionUnposted)
 #define scProBaseRevisionUnposted scProRevisionUnposted
#endif

#if !defined(DO_scProSecurity)
 #define scProBaseSecurity        scProSecurity
#endif

#if !defined(DO_scProTableEmpty)
 #define scProBaseTableEmpty      scProTableEmpty
#endif

#if !defined(DO_scProType)
 #define scProBaseType            scProType
#endif

#if !defined(DO_scProUnLock)
 #define scProBaseUnLock          scProUnLock
#endif

#if !defined(DO_scProUpdate)
 #define scProBaseUpdate          scProUpdate
#endif

#if !defined(DO_scProVerify)
 #define scProBaseVerify          scProVerify
#endif
...
#define scProExtendedBaseAttribs           scProBaseAttribs
#define scProExtendedBaseBlkGet            scProBaseBlkGet
#define scProExtendedBaseBlkPut            scProBaseBlkPut
#define scProExtendedBaseBrowse            scProBaseBrowse
#define scProExtendedBaseCancel            scProBaseCancel
#define scProExtendedBaseClose             scProBaseClose
#define scProExtendedBaseCmpNames          scProBaseCmpNames
#define scProExtendedBaseCompose           scProBaseCompose
#define scProExtendedBaseCreate            scProBaseCreate
#define scProExtendedBaseDelete            scProBaseDelete
#define scProExtendedBaseDirty             scProBaseDirty
#define scProExtendedBaseDrop              scProBaseDrop
#define scProExtendedBaseExists            scProBaseExists
#define scProExtendedBaseFetch             scProBaseFetch
#define scProExtendedBaseFetchLock         scProBaseFetchLock
#define scProExtendedBaseField             scProBaseField
#define scProExtendedBaseFieldExists       scProBaseFieldExists
#define scProExtendedBaseFieldName         scProBaseFieldName
#define scProExtendedBaseFields            scProBaseFields
#define scProExtendedBaseFilterCount       scProBaseFilterCount
#define scProExtendedBaseFilterDelete      scProBaseFilterDelete
#define scProExtendedBaseFilterFetch       scProBaseFilterFetch
#define scProExtendedBaseFilterSelect      scProBaseFilterSelect
#define scProExtendedBaseGet               scProBaseGet
#define scProExtendedBaseInit              scProBaseInit
#define scProExtendedBaseInsert            scProBaseInsert
#define scProExtendedBaseInstanceFieldList scProBaseInstanceFieldList
#define scProExtendedBaseInstanceNotify    scProBaseInstanceNotify
#define scProExtendedBaseInstanceOpen      scProBaseInstanceOpen
#define scProExtendedBaseInstanceProtocol  scProBaseInstanceProtocol
#define scProExtendedBaseInstanceSecurity  scProBaseInstanceSecurity
#define scProExtendedBaseKey               scProBaseKey
#define scProExtendedBaseKeys              scProBaseKeys
#define scProExtendedBaseName              scProBaseName
#define scProExtendedBaseOpen              scProBaseOpen
#define scProExtendedBaseOrder             scProBaseOrder
#define scProExtendedBasePost              scProBasePost
#define scProExtendedBasePresents          scProBasePresents
#define scProExtendedBaseProcess           scProBaseProcess
#define scProExtendedBasePut               scProBasePut
#define scProExtendedBaseRead              scProBaseRead
#define scProExtendedBaseReadLock          scProBaseReadLock
#define scProExtendedBaseRecordClear       scProBaseRecordClear
#define scProExtendedBaseRecordGenerate    scProBaseRecordGenerate
#define scProExtendedBaseRevisionCancel    scProBaseRevisionCancel
#define scProExtendedBaseRevisionExists    scProBaseRevisionExists
#define scProExtendedBaseRevisionPost      scProBaseRevisionPost
#define scProExtendedBaseRevisionRekey     scProBaseRevisionRekey
#define scProExtendedBaseRevisionUnposted  scProBaseRevisionUnposted
#define scProExtendedBaseSecurity          scProBaseSecurity
#define scProExtendedBaseTableEmpty        scProBaseTableEmpty
#define scProExtendedBaseType              scProBaseType
#define scProExtendedBaseUnLock            scProBaseUnLock
#define scProExtendedBaseUpdate            scProBaseUpdate
#define scProExtendedBaseVerify            scProBaseVerify

#else

VIEWCALL scProBaseAttribs (LPVOID lpView, LONG lField, LPLONG lpAttributes)
{
   ERRNUM e = scProExtendedBaseAttribs (lpView, lField, lpAttributes);
...
VIEWCALL scProBaseBlkGet (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer)
{
   ERRNUM e = scProExtendedBaseBlkGet (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer);
...
VIEWCALL scProBaseBlkPut (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer, BOOL bVerify)
{
   ERRNUM e = scProExtendedBaseBlkPut (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer, bVerify);
...
VIEWCALL scProBaseBrowse (LPVOID lpView, LPSTR lpsExpression, BOOL bAscending)
{
   ERRNUM e = scProExtendedBaseBrowse (lpView, lpsExpression, bAscending);
...
VIEWCALL scProBaseCancel (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseCancel (lpView);
...
VIEWCALL scProBaseClose (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseClose (lpView);
...
VIEWCALL scProBaseCmpNames (INT roto, LPSTR lpsCompositeNames, LPSHORT lpnCount)
{
   ERRNUM e = scProExtendedBaseCmpNames (roto, lpsCompositeNames, lpnCount);
...
VIEWCALL scProBaseCompose (LPVOID lpView, LPVIEWDEF lpvdefComposites)
{
   ERRNUM e = scProExtendedBaseCompose (lpView, lpvdefComposites);
...
VIEWCALL scProBaseCreate (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scProExtendedBaseCreate (hPIB, wLinkNo);
...
VIEWCALL scProBaseDelete (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseDelete (lpView);
...
VIEWCALL scProBaseDirty (LPVOID lpView, LPBOOL bChanged)
{
   ERRNUM e = scProExtendedBaseDirty (lpView, bChanged);
...
VIEWCALL scProBaseDrop (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scProExtendedBaseDrop (hPIB, wLinkNo);
...
VIEWCALL scProBaseExists (LPVOID lpView, LPBOOL bExists)
{
   ERRNUM e = scProExtendedBaseExists (lpView, bExists);
...
VIEWCALL scProBaseFetch (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseFetch (lpView);
...
VIEWCALL scProBaseFetchLock (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseFetchLock (lpView);
...
VIEWCALL scProBaseField (LPVOID lpView, INT nFldNumber, LPSTR lpsFldName, LPLONG lField)
{
   ERRNUM e = scProExtendedBaseField (lpView, nFldNumber, lpsFldName, lField);
...
VIEWCALL scProBaseFieldExists (LPV view, LONG lField, LP_A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseFieldExists (view, lField, flags);
...
VIEWCALL scProBaseFieldName (LPV view, LONG lField, LPSTR lpsName, LPSTR lpsDesc, A4W_SIZE size)
{
   ERRNUM e = scProExtendedBaseFieldName (view, lField, lpsName, lpsDesc, size);
...
VIEWCALL scProBaseFields (LPVOID lpView, LPSHORT lFields)
{
   ERRNUM e = scProExtendedBaseFields (lpView, lFields);
...
VIEWCALL scProBaseFilterCount (LPV view, LPSTR filter, A4W_FLAGS flags, LP_A4W_SIZE count)
{
   ERRNUM e = scProExtendedBaseFilterCount (view, filter, flags, count);
...
VIEWCALL scProBaseFilterDelete (LPV view, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseFilterDelete (view, filter, flags);
...
VIEWCALL scProBaseFilterFetch (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseFilterFetch (view, flags);
...
VIEWCALL scProBaseFilterSelect (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseFilterSelect (view, key, filter, flags);
...
VIEWCALL scProBaseGet (LPVOID lpView, LONG lField, LPSTR buffer, INT nSize)
{
   ERRNUM e = scProExtendedBaseGet (lpView, lField, buffer, nSize);
...
VIEWCALL scProBaseInit (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseInit (lpView);
...
VIEWCALL scProBaseInsert (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseInsert (lpView);
...
VIEWCALL scProBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = scProExtendedBaseInstanceFieldList (view, flags, count, fields);
...
VIEWCALL scProBaseInstanceNotify (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseInstanceNotify (view, notify, context, flags);
...
VIEWCALL scProBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
   ERRNUM e = scProExtendedBaseInstanceOpen (rvh, PIB, link, flags, extra, size, view);
...
VIEWCALL scProBaseInstanceProtocol (LPV view, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = scProExtendedBaseInstanceProtocol (view, flags, protocols, count);
...
VIEWCALL scProBaseInstanceSecurity (LPV view, LP_A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseInstanceSecurity (view, flags);
...
VIEWCALL scProBaseKey (LPVOID lpView, INT nKeyNo, LPSTR sName, LPSHORT lFields, LPLONG lplKeyFields)
{
   ERRNUM e = scProExtendedBaseKey (lpView, nKeyNo, sName, lFields, lplKeyFields);
...
VIEWCALL scProBaseKeys (LPVOID lpView, LPSHORT lpnKeys)
{
   ERRNUM e = scProExtendedBaseKeys (lpView, lpnKeys);
...
VIEWCALL scProBaseName (LPVOID lpView, LONG lField, LPSTR lpsName, LPSTR lpsDesc)
{
   ERRNUM e = scProExtendedBaseName (lpView, lField, lpsName, lpsDesc);
...
VIEWCALL scProBaseOpen (HPIB hPIB, WORD wLinkNo, LPVOID FAR * lpView)
{
   ERRNUM e = scProExtendedBaseOpen (hPIB, wLinkNo, lpView);
...
VIEWCALL scProBaseOrder (LPVOID lpView, INT nKey)
{
   ERRNUM e = scProExtendedBaseOrder (lpView, nKey);
...
VIEWCALL scProBasePost (LPVOID lpView)
{
   ERRNUM e = scProExtendedBasePost (lpView);
...
VIEWCALL scProBasePresents (LPVOID lpView, LONG lField, LPSTR lpsMask, LPSHORT lpnList, LPSHORT lpnCount, LPVOID lpBuffer, INT nSize)
{
   ERRNUM e = scProExtendedBasePresents (lpView, lField, lpsMask, lpnList, lpnCount, lpBuffer, nSize);
...
VIEWCALL scProBaseProcess (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseProcess (lpView);
...
VIEWCALL scProBasePut (LPVOID lpView, LONG lField, LPSTR lpsBuffer, INT nSize, BOOL bVerify)
{
   ERRNUM e = scProExtendedBasePut (lpView, lField, lpsBuffer, nSize, bVerify);
...
VIEWCALL scProBaseRead (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseRead (lpView);
...
VIEWCALL scProBaseReadLock (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseReadLock (lpView);
...
VIEWCALL scProBaseRecordClear (LPV view)
{
   ERRNUM e = scProExtendedBaseRecordClear (view);
...
VIEWCALL scProBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseRecordGenerate (view, flags);
...
VIEWCALL scProBaseRevisionCancel (LPV view, INT level)
{
   ERRNUM e = scProExtendedBaseRevisionCancel (view, level);
...
VIEWCALL scProBaseRevisionExists (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseRevisionExists (view, level, flags);
...
VIEWCALL scProBaseRevisionPost (LPV view, INT level)
{
   ERRNUM e = scProExtendedBaseRevisionPost (view, level);
...
VIEWCALL scProBaseRevisionRekey (LPV view, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseRevisionRekey (view, OldKey, NewKey, size, flags);
...
VIEWCALL scProBaseRevisionUnposted (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scProExtendedBaseRevisionUnposted (view, level, flags);
...
VIEWCALL scProBaseSecurity (HPIB hPIB, WORD wLinkNo, LPLONG lplPermissions)
{
   ERRNUM e = scProExtendedBaseSecurity (hPIB, wLinkNo, lplPermissions);
...
VIEWCALL scProBaseTableEmpty (LPV view)
{
   ERRNUM e = scProExtendedBaseTableEmpty (view);
...
VIEWCALL scProBaseType (LPVOID lpView, LONG lField, LPTYPE lptype)
{
   ERRNUM e = scProExtendedBaseType (lpView, lField, lptype);
...
VIEWCALL scProBaseUnLock (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseUnLock (lpView);
...
VIEWCALL scProBaseUpdate (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseUpdate (lpView);
...
VIEWCALL scProBaseVerify (LPVOID lpView)
{
   ERRNUM e = scProExtendedBaseVerify (lpView);
...
VIEWCALL rotoEntryBase (LPROTOVIEW v, INT length)
{
   ...
   switch ( v->op ) {
      case VIEW_OP_ATTRIBUTES :
         e = scProAttribs (v->view, MapToNewFieldIndex (v->field), (LPLONG) v->p);
         break;
      case VIEW_OP_BLKGET :
         e = scProBlkGet (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r);
         break;
      case VIEW_OP_BLKPUT :
         e = scProBlkPut (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r, v->flag);
         break;
      case VIEW_OP_BROWSE :
         e = scProBrowse (v->view, (LPSTR) v->p, v->flag);
         break;
      case VIEW_OP_CANCEL :
         e = scProCancel (v->view);
         break;
      case VIEW_OP_CLOSE :
         e = scProClose (v->view);
         break;
      case VIEW_OP_COMPOSE :
         e = scProCompose (v->view, (LPVIEWDEF) v->p);
         break;
      case VIEW_OP_COMPOSITES :
         e = scProCmpNames (v->i, (LPSTR) v->p, (LPSHORT) v->q);
         break;
      case VIEW_OP_CREATE :
         e = scProCreate (v->i, v->x);
         break;
      case VIEW_OP_DELETE :
         e = scProDelete (v->view);
         break;
      case VIEW_OP_DIRTY :
         e = scProDirty (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_DROP :
         e = scProDrop (v->i, v->x);
         break;
      case VIEW_OP_EXISTS :
         e = scProExists (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_FETCH :
         e = scProFetch (v->view);
         break;
      case VIEW_OP_FETCH_LOCK :
         e = scProFetchLock (v->view);
         break;
      case VIEW_OP_FIELD :
         e = scProField (v->view, v->i, (LPSTR) v->p, (LPLONG) v->q);
         break;
      case VIEW_OP_FIELD_EXISTS :
         e = scProFieldExists ((LPV) v->view, v->field, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_FIELD_NAME :
         e = scProFieldName ((LPV) v->view, v->field, (LPSTR) v->p, (LPSTR) v->q, v->i);
         break;
      case VIEW_OP_FIELDS :
         e = scProFields (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_FILTER_COUNT :
         e = scProFilterCount ((LPV) v->view, (LPSTR) v->p, v->dw, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_FILTER_DELETE :
         e = scProFilterDelete ((LPV) v->view, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_FILTER_FETCH :
         e = scProFilterFetch ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_FILTER_SELECT :
         e = scProFilterSelect ((LPV) v->view, v->i, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_GET :
         e = scProGet (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i);
         break;
      case VIEW_OP_INITIALIZE :
         e = scProInit (v->view);
         break;
      case VIEW_OP_INSERT :
         e = scProInsert (v->view);
         break;
      case VIEW_OP_INSTANCE_FIELDLIST :
         e = scProInstanceFieldList ((LPV) v->view, v->dw, v->i, (PLONG) v->p);
         break;
      case VIEW_OP_INSTANCE_NOTIFY :
         e = scProInstanceNotify ((LPV) v->view, (A4W_NOTIFY_PROC) v->p, v->q, v->dw);
         break;
      case VIEW_OP_INSTANCE_OPEN :
#if defined(DO_OPENETC) || !defined(DO_scProOpen) || defined(DO_scProInstanceOpen)
         e = scProInstanceOpen ((LPRVH) v->p, v->i, v->x, v->dw,
                               v+1, length-sizeof (ROTOVIEW), (LPV *) &v->view);
#else
         e = scProOpen (v->i, v->x, &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scProInstanceOpen() is redirected to scProOpen() because scProOpen() is")
  #warning ("overridden, scProInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #warning ("loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scProInstanceOpen() is redirected to scProOpen() because scProOpen() is")
  #pragma message ("overridden, scProInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #pragma message ("loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_INSTANCE_PROTOCOL :
         e = scProInstanceProtocol ((LPV) v->view, v->dw, (LP_A4W_FLAGS) v->p, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_INSTANCE_SECURITY :
         e = scProInstanceSecurity ((LPV) v->view, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_KEY :
         e = scProKey (v->view, v->i, (LPSTR) v->p, (LPSHORT) v->q, (LPLONG) v->r);
         break;
      case VIEW_OP_KEYS :
         e = scProKeys (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_NAME :
         e = scProName (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, (LPSTR) v->q);
         break;
      case VIEW_OP_OPEN :
#if defined(DO_OPENETC) || defined(DO_scProOpen) || !defined(DO_scProInstanceOpen)
         e = scProOpen (v->i, v->x, &v->view);
#else
         e = scProInstanceOpen (NULL, v->i, v->x, 0L, NULL, 0, (LPV *) &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scProOpen() is redirected to scProInstanceOpen() because")
  #warning ("scProInstanceOpen() is overridden, scProOpen() isn't, and OpenEtc() isn't used.")
  #warning ("To avoid this loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scProOpen() is redirected to scProInstanceOpen() because")
  #pragma message ("scProInstanceOpen() is overridden, scProOpen() isn't, and OpenEtc() isn't used.")
  #pragma message ("To avoid this loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_ORDER :
         e = scProOrder (v->view, v->i);
         break;
      case VIEW_OP_POST :
         e = scProPost (v->view);
         break;
      case VIEW_OP_PRESENTATION :
         e = scProPresents (v->view, MapToNewFieldIndex (v->field),
                           (LPSTR) v->p, (LPSHORT) v->q, (LPSHORT) v->r, v->s, v->i);
         break;
      case VIEW_OP_PROCESS :
         e = scProProcess (v->view);
         break;
      case VIEW_OP_PUT :
         e = scProPut (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i, v->flag);
         break;
      case VIEW_OP_READ :
         e = scProRead (v->view);
         break;
      case VIEW_OP_READ_LOCK :
         e = scProReadLock (v->view);
         break;
      case VIEW_OP_RECORD_CLEAR :
         e = scProRecordClear ((LPV) v->view);
         break;
      case VIEW_OP_RECORD_GENERATE :
         e = scProRecordGenerate ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_REVISION_CANCEL :
         e = scProRevisionCancel ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_EXISTS :
         e = scProRevisionExists ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_REVISION_POST :
         e = scProRevisionPost ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_REKEY :
         e = scProRevisionRekey ((LPV) v->view, v->p, v->q, v->i, v->dw);
         break;
      case VIEW_OP_REVISION_UNPOSTED :
         e = scProRevisionUnposted ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_SECURITY :
         e = scProSecurity (v->i, v->x, (LPLONG) v->p);
         break;
      case VIEW_OP_TABLE_EMPTY :
         e = scProTableEmpty ((LPV) v->view);
         break;
//////////////////////////////////////////////////////////////////////////////
// Experimental stuff
      case VIEW_OP_TABLE_HANDLES :
         e = scProTableHandles ((LPV) v->view, v->i, (LPWORD) v->p);
         break;
//////////////////////////////////////////////////////////////////////////////
      case VIEW_OP_TYPE :
         e = scProType (v->view, MapToNewFieldIndex (v->field), (LPTYPE) v->p);
         break;
      case VIEW_OP_UNLOCK :
         e = scProUnLock (v->view);
         break;
      case VIEW_OP_UPDATE :
         e = scProUpdate (v->view);
         break;
      case VIEW_OP_VERIFY :
         e = scProVerify (v->view);
         break;
      default :
...
VIEWCALL identifyEntry (LPIDENTIFYVIEW identify, INT length)
{
   switch ( identify->op ) {
      case IDENTIFY_OP_VERSION_TEMPLATE:
         return scProVersionTemplate (identify->pib, identify->TextDatum, (LPBCDDATE) identify->BinaryDatum);
      case IDENTIFY_OP_VERSION_API:
         return scProVersionAPI (identify->pib, identify->TextDatum);
      case IDENTIFY_OP_VIEW_NAME:
         return scProViewName (identify->pib, identify->TextDatum, identify->TextLength);
      case IDENTIFY_OP_VIEW_TABLE_COUNT:
         return scProViewTableCount (identify->pib, (LPSHORT) identify->BinaryDatum);
      case IDENTIFY_OP_VIEW_TABLES:
         return scProViewTables (identify->pib, identify->TextDatum, identify->TextLength);
      default:
...
/*--------------------------------------------------------------------
   ...
   can change.
*/
VIEWCALL scProExtendedBaseAttribs (
   LPVOID lpView,
   LONG nField,
...
/*--------------------------------------------------------------------
   ...
   can be used in place of several scProGet calls to minimize the
   number of view calls.
*/
VIEWCALL scProExtendedBaseBlkGet (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scProGet (lpView, field, &lpsBuffer[nPos], size));
#else
...
/*--------------------------------------------------------------------
   ...
   of several scProPut calls to minimize the number of view calls.
*/
VIEWCALL scProExtendedBaseBlkPut (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scProPut (lpView, field, &lpsBuffer[nPos], size, bVerify));
#else
      if ( ValidIndexV (lpv, field) ) {
         BASE_BLK_PUT();
         nPosSub = nPos + size;
...
/*--------------------------------------------------------------------
   ...
   and direction for subsequent scProRead and scProFetch calls. The
   key to start from is specified by the current contents of the
   logical record.
*/
VIEWCALL scProExtendedBaseBrowse (
   LPVOID lpView,
   LPSTR lpsExpression,
   BOOL bAscending)
{
...
/*--------------------------------------------------------------------
   ...
   conjunction with scProPost.
*/
VIEWCALL scProExtendedBaseCancel (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   Closes an open view.
*/
VIEWCALL scProExtendedBaseClose (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   INT nTbl;
...
/*--------------------------------------------------------------------
   ...
   compose. If lpsCompositeNames is a null address, scProCmpNames will
   not return the list of view rotoIDS. Instead, scProCmpNames will
   return the size of the buffer required to hold the sequence of
   character strings in *lpnCount.
*/
VIEWCALL scProExtendedBaseCmpNames (
   INT roto,
...
*/
VIEWCALL scProExtendedBaseCompose (
   LPVOID lpView,
...
*/
VIEWCALL scProExtendedBaseCreate (
   HPIB hPIB,
   WORD wLinkNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scProExtendedBaseDelete (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Reports whether fields have been altered with scProPut calls.
*/
VIEWCALL scProExtendedBaseDirty (
   LPVOID lpView,
   LPBOOL lpbChanged)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Deletes tables created by scProCreate from the database denoted by
   wLinkNo. You should not currently be in a transaction when
   calling this function.
*/
VIEWCALL scProExtendedBaseDrop (
   HPIB hPIB,
   WORD wLinkNo)
{
...
*/
VIEWCALL scProExtendedBaseExists (
   LPVOID lpView,
   LPBOOL lpbExists)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   filter set in the last scProBrowse call.
*/
VIEWCALL scProExtendedBaseFetch (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Retrieves the next logical record according to the direction and
   filter set in the last scProBrowse call. scProFetchLock is the
   same as scProFetch except that the record is locked.
*/
VIEWCALL scProExtendedBaseFetchLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scProExtendedBaseField (
   LPVOID lpView,
   INT nFldNumber,
   LPSTR lpsFldName,
   LPLONG lplField)
...
*/
VIEWCALL scProExtendedBaseFieldExists (
   LPV view,
   LONG lField,
   LP_A4W_FLAGS flags)
{
...
*/
VIEWCALL scProExtendedBaseFieldName (
   LPV view,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc,
...
*/
VIEWCALL scProExtendedBaseFields (
   LPVOID lpView,
   LPSHORT lpnFields)
{
   if ( SUBCLASS_LEVEL==NOT_SUBCLASS ) {
...
VIEWCALL scProExtendedBaseFilterCount (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags,
   LP_A4W_SIZE count)
{
   ...
   if ( expression==NULL ) {
      ...
      f = filterExprSegments (lpv, &lpv->filter, lpv->wDetailFilterSegments,
                              (FILTERNAME) xxxNameOnly, (FILTERGET) scProGet, &range);
      RVSPYTRACE (range);
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, range, &filter, (FILTERFIELD) scProField, (FILTERFIELDS) scProFields, (FILTERTYPE) scProType);
...
*/
VIEWCALL scProExtendedBaseFilterDelete (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags)
{
...
VIEWCALL scProExtendedBaseFilterFetch       (LPV lpv, A4W_FLAGS flags)
{
...
VIEWCALL scProExtendedBaseFilterSelect     (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   ...
   CHECK_CALL (e, scProOrder (view, key));
   CHECK_CALL (e, scProBrowse (view, filter, ascending));
   return e;
}
   ...
   INT nSize)
{
   ...
   if ( lField==DIRTY_IDX ) {
      ...
      CHECK_CALL (e, scProRevisionUnposted (lpv, 1+HDR_HAS_REVISIONS, &flags));
...
/*--------------------------------------------------------------------
   ...
   field in a view.
*/
VIEWCALL scProExtendedBaseInit (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   record is not added.
*/
VIEWCALL scProExtendedBaseInsert (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==SEQUENCE_REVISIONS && GENERATEKEY_NONE==lpv->bKeyGenerated ) {
      ...
      // of its details, the key must have been generated via scProRecordGenerate()
      int c;
...
VIEWCALL scProExtendedBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseInstanceNotify   (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
...
VIEWCALL scProExtendedBaseInstanceProtocol (LPV lpv, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseInstanceSecurity (LPV lpv, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   conjunction with scProKey to retrieve information about key
   structure.
*/
VIEWCALL scProExtendedBaseKeys (
   LPVOID lpView,
   LPSHORT lpnKeys)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scProExtendedBaseName (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc)
...
*/
VIEWCALL scProExtendedBaseOpen (
   HPIB hPIB,
   WORD wLinkNo,
   LPVOID FAR * lplpView)
{
...
*/
VIEWCALL scProExtendedBaseOrder (
   LPVOID lpView,
   INT nKeyNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scProExtendedBasePost (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scProPost is no longer supported on non-revisioned views.");
   }
#endif
...
*/
VIEWCALL scProExtendedBasePresents (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsMask,
   LPSHORT lpnList,
...
*/
VIEWCALL scProExtendedBaseProcess (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
   ...
   if ( (* comparator) (f, (LPDATUM) target, (LPDATUM) normalized)!=0 ) {
      ...
      if ( attribs & ATTR_KEY ) {
         ...
         blkSet ((FindRecord (lpv)) [BASE_TBL_COUNT] +
                  FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCPRO_FLD_AUDIT].wOffset,
                 ' ', sizeof (AUDITSTAMP));
#endif
         if ( SUBCLASS_LEVEL!=NOT_SUBCLASS ) {
            CHECK_CALL (e, BaseBrowse (lpv, FALSE));
...
*/
VIEWCALL scProExtendedBaseRead (
   LPVOID lpView)
{
...
/*--------------------------------------------------------------------
   Fetches the logical record index by the current contents of the
   view's key fields. If there are composite views, the caller is
   responsible for reading them in as well. scProReadLock is the
   same as scProRead except that the record is locked.
*/
VIEWCALL scProExtendedBaseReadLock (
   LPVOID lpView)
{
...
VIEWCALL scProExtendedBaseRecordClear (LPV view)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseRevisionCancel   (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseRevisionExists   (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
...
VIEWCALL scProExtendedBaseRevisionPost     (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
   REV_ERRNUM r = POST_DONE;
...
#if !(defined(DETAIL_VIEW) || defined(SUPER_VIEW))
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scProRevisionPost is no longer supported on non-revisioned views.");
   }
#endif
...
VIEWCALL scProExtendedBaseRevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProExtendedBaseRevisionUnposted (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   BOOL dirty = FALSE;
...
/*--------------------------------------------------------------------
   ...
   given database link.
*/
VIEWCALL scProExtendedBaseSecurity (
   HPIB hPIB,
   WORD wLinkNo,
...
*/
VIEWCALL scProExtendedBaseTableEmpty (LPV lpv)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   varies by type.
*/
VIEWCALL scProExtendedBaseType (
   LPVOID lpView,
   LONG nField,
   LPTYPE lptype)
{
...
/*--------------------------------------------------------------------
   Unlocks the logical record locked by the scProFetchLock or the
   scProReadLock calls.
*/
VIEWCALL scProExtendedBaseUnLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   ...
   been altered; if they are use the scProInsert routine instead.
*/
VIEWCALL scProExtendedBaseUpdate (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scProExtendedBaseVerify (
   LPVOID lpView)
{
...
VIEWBASE xxxFetchFilterBase (LPV lpv, INT flags, LPFILTER filter, LPSHORT range, BOOL ascending)
{
   ...
   if ( !started ) {
      ...
      f = filterInitRange (lpv, filter, ascending, range,
                           (FILTERGET) scProGet, (FILTERPUT) scProPut);
   ...
   for (;;) {
      ...
      switch ( d ) {
         ...
         case DBS_CVIEW_WARNING:
            ...
            f = filterEval (lpv, (FILTERGET) scProGet, filter, ascending, *range);
            switch ( f ) {
               case FL_SUCCESS:
                  goto RecordFound;
               case FL_FAIL:
      ...
      if ( f==FL_END_OF_RANGE || d==DBS_NO_MORE_DATA ) {
         ...
         f = filterPutRange (lpv, filter, ascending, *range, (FILTERPUT) scProPut);
         if ( FL_ERRNUM_IS_FAILURE (f) )
            goto ReturnFilterError;
         if ( DB_ERRNUM_IS_FAILURE (d) )
            d = DBS_SUCCESS;
...
VIEWCALL xxxKey (
   ...
   LPSHORT lpnFields,
   LPLONG lplKeyFields)
// Call gate for scProKey, intended for use by the filter* routines.
// It Suppresses reporting of boundary errors, though others may be reported.
{
   ...
   *lpnFields = 0;
   ...
   MaxError (&e, scProKey (lpView, nKeyNo, lpsName, lpnFields, lplKeyFields));
   return e;
}
...
#define VALIDATE(__expr__) {          \
   ...
   if ( lpv->bVerified ) {
      ...
      CHECK_CALL_GOTO (e, protocol_error, scProDirty (lpView, &dirty));
#endif
      if ( !dirty )
          return ERRNUM_SUCCESS;
   }
   ...
   if ( SUBCLASS_LEVEL!=NOT_SUBCLASS && verifying && VIEW_OP (lpv, OPEN)==VIEW_OP_VERIFY ) {
      // Only propagate verification if scProVerify really was called
...
VIEWBASE BrowseBody (LPV lpv, LPSTR expression, BOOL ascending)
{
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, expression, &lpv->filter, (FILTERFIELD) scProField,
                    (FILTERFIELDS) scProFields, (FILTERTYPE) scProType);
   CHECK_CALL (e, ErrorMapFilterToExtended (op, filterErrorV (lpv, op, f)));
...
// scProFilterDelete(), along with all its limitations. In particular,
   ...
   INT nSize)
{
   ...
   if ( nSize!=sizeof(etag) )
   {
      ReportError (lpv, (RSCID)IDERR_SC_BUFFER_MSG,
                   MAKERSC(IDS_SCPRO_VIEW_NOUN), "ETAG", NULL);
      return ERRNUM_MEMORY_BUFFER_LIMIT;
   }
   ...
   if ( HAS_DATABASE_TABLES )
   {
      ...
      lpadt = (LPAUDITSTAMP) (FindRecord (lpv) [BASE_TBL_COUNT] +
                              FindTableMap (BASE_TBL_COUNT)->fields[SCPRO_FLD_AUDIT].wOffset);
   }
   else
   {
      DBDATE dbDate;
...
VIEWBASE GenerateKeyReally (LPV lpv)
{
   ...
   INT primary = FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCPRO_FLD_AUDIT].wOffset;
...
A4W_FLAGS WINAPI GetPermissions (LPV lpv)
{
   ...
   e = scProInstanceSecurity (lpv, &permissions);
   if ( ERRNUM_IS_FAILURE (e) )
      permissions = 0;
   return permissions;
}
...
// This function should NEVER be called from scProPost or scProCancel entrypoints
...
VIEWBASE NotifyClose (LPV lpv)
{
   ...
   for ( c=0; c<EXP_CMP_COUNT; ++c ) {
      ...
      if ( (d && (d->options & CMPNAME_OPTION_NOTIFY)) ||
         ...
         // scProClose, so we have to try to clear away everything.
      }
   }
...
#if defined(SCPRO_ROTOID)
   utlObjStrToID (SCPRO_ROTOID, &lpv->rotoID);
#endif
      ...
      switch ( e ) {
         ...
         case ERRNUM_OPEN_FAILED:
            ReportError (lpv, (RSCID)IDERR_SC_VIEWOPEN_MSG,
                         MAKERSC(IDS_SCPRO_VIEW_NOUN), NULL, NULL);
            break;
...
#define REPORT_USE_ERROR(v,e,f) \
   ReportError ((v), (RSCID)(e), MAKERSC(IDS_SCPRO_VIEW_NOUN), \
...
void WINAPI ReportBaseLoadError (HPIB hpib, LPSTR rotoID)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_VIEWLOAD_MSG,
                      MAKERSC(IDS_SCPRO_VIEW_NOUN), rotoID, NULL);
}
...
void WINAPI ReportBaseMemoryError (HPIB hpib, RSCID op)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_MEMORY_MSG,
                      MAKERSC(IDS_SCPRO_VIEW_NOUN), MAKERSC(op), NULL);
}
...
void WINAPI ReportCompositeKeyError (LPV lpv, RSCID op, LPSTR rotoID)
{
   ReportError (lpv, (RSCID)IDERR_SC_CMPKEY_MSG,
                MAKERSC(IDS_SCPRO_VIEW_NOUN), MAKERSC(op), rotoID);
}
...
void WINAPI ReportFieldError (LPV lpv, INT field)
{
   ...
   ReportError (lpv, (RSCID)IDERR_SC_FLDNUM_MSG,
                MAKERSC(IDS_SCPRO_VIEW_NOUN), value, NULL);
}
...
{
   errPutGeneric (lpv->hpib, APPL, MAKERSC (IDS_SCPRO_VIEW_NOUN), NULL,
...
{
   errPutGeneric (pib, APPL, MAKERSC(IDS_SCPRO_VIEW_NOUN), NULL,
                  area, op, MAKERSC (ERRGEN_CAT_DEFAULT), error, extra);
}
...
void WINAPI ReportString (LPSTR message)
{
   ...
   buffer[0] = 0;
#if defined(SCPRO_ROTOID)
   strCopy (buffer, SCPRO_ROTOID);
   strAppend (buffer, ": ");
#endif
   strAppend (buffer, "<SCPRO> ");
...
void WINAPI ScratchError (LPV lpv)
{
   ...
   rscLoadText (lpv->hpib, APPL, IDS_SCPRO_VIEW_NOUN, noun, sizeof (noun));
...
DB_ERRNUM WINAPI RevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ...
   primary = FindTableMapV (lpv, i)->fields[SCPRO_FLD_AUDIT].wOffset;
   if ( HDR_HAS_REVISIONS==0 )
      // Note: this only works for MP3 records
      iHdrPKeySize = (INT) FindTableMapV (lpv, i)->fields[SCPRO_FLD_AUDIT - DTL_SEG_COUNT].wOffset;
   else
 ...
 * I/O, copy these corresponding functions out of the scPro.C file replacing *
...
DB_ERRNUM WINAPI fileAddBase (WORD wLinkNo, HPIB hpib)
{
   ...
   MaxDatabaseError (&d, ErrorMapViewToDatabase (VIEW_OP_OPEN,
                                                 scProOpen (hpib, wLinkNo, (LPVOID *) &lpv)));
   if ( DB_ERRNUM_IS_SUCCESS (d) ) {
      ...
      if ( !lpv->bRevisioned ) {
         ...
         if ( lpv->bReadOnly ) {
            ...
            FL_ERRNUM f = filterExprFirst (lpv, &lpv->filter,
               (FILTERNAME) xxxNameOnly, (FILTERGET) scProGet, lpv->bAhead, &first);
            ...
            if ( DB_ERRNUM_IS_SUCCESS (d) ) {
               ...
               f = filterExprSegments (lpv, &lpv->filter, nSegs,
                  (FILTERNAME) xxxNameOnly, (FILTERGET) scProGet, &detail);
               RVSPYTRACE (detail);
               filterErrorV (lpv, op, f);
               MaxDatabaseError (&d, ErrorMapFilterToDatabase (op, f));
               if ( DB_ERRNUM_IS_SUCCESS (d) ) {
...
{
   DB_ERRNUM d = DBS_SUCCESS;
   CHAR array[SIZEOF_TABLENAME] = {'S','C','P','R','O',' ',' ',' '};
   LPSTR name = array;
      ...
      for ( i=BASE_TBL_COUNT; i<BASE_TBL_COUNT+TBL_COUNT; i++ ) {
         ...
         if ( DB_ERRNUM_IS_SUCCESS (d) ) {
            ...
            if ( DBS_DD_INCONSISTENT==d ||
               ...
               // in all subsequent scProInstanceFieldList() calls
            }
         }
         if ( DB_ERRNUM_IS_FAILURE (d) ) {
            while ( --i>=BASE_TBL_COUNT )
...
*/
VIEWCALL scProTableHandles (LPV lpv, INT count, LPWORD handles)
{
   ERRNUM e = ERRNUM_SUCCESS;
   INT i;
   SHORT baseTables = 0;
...
VIEWCALL scProVersionTemplate (INT roto, LPSTR version, LPBCDDATE date)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProVersionAPI (INT roto, LPSTR version)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProViewName (HPIB pib, LPSTR name, INT size)
{
   rscLoadText (pib, APPL, IDS_SCPRO_VIEW_NAME, name, size);
   return ERRNUM_SUCCESS;
}



VIEWCALL scProViewTableCount (INT roto, LPSHORT tableCount)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scProViewTables (INT roto, LPSTR tableNames, INT size)
{
   INT i;
   SHORT baseTables = 0;
   ERRNUM e = ERRNUM_SUCCESS;
