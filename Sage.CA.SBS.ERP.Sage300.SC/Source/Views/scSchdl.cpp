...
#if !defined(DO_scSchdlAttribs)
 #define scSchdlBaseAttribs         scSchdlAttribs
#endif

#if !defined(DO_scSchdlBlkGet)
 #define scSchdlBaseBlkGet          scSchdlBlkGet
#endif

#if !defined(DO_scSchdlBlkPut)
 #define scSchdlBaseBlkPut          scSchdlBlkPut
#endif

#if !defined(DO_scSchdlBrowse)
 #define scSchdlBaseBrowse          scSchdlBrowse
#endif

#if !defined(DO_scSchdlCancel)
 #define scSchdlBaseCancel          scSchdlCancel
#endif

#if !defined(DO_scSchdlClose)
 #define scSchdlBaseClose           scSchdlClose
#endif

#if !defined(DO_scSchdlCmpNames)
 #define scSchdlBaseCmpNames        scSchdlCmpNames
#endif

#if !defined(DO_scSchdlCompose)
 #define scSchdlBaseCompose         scSchdlCompose
#endif

#if !defined(DO_scSchdlCreate)
 #define scSchdlBaseCreate          scSchdlCreate
#endif

#if !defined(DO_scSchdlDelete)
 #define scSchdlBaseDelete          scSchdlDelete
#endif

#if !defined(DO_scSchdlDirty)
 #define scSchdlBaseDirty           scSchdlDirty
#endif

#if !defined(DO_scSchdlDrop)
 #define scSchdlBaseDrop            scSchdlDrop
#endif

#if !defined(DO_scSchdlExists)
 #define scSchdlBaseExists          scSchdlExists
#endif

#if !defined(DO_scSchdlFetch)
 #define scSchdlBaseFetch           scSchdlFetch
#endif

#if !defined(DO_scSchdlFetchLock)
 #define scSchdlBaseFetchLock       scSchdlFetchLock
#endif

#if !defined(DO_scSchdlField)
 #define scSchdlBaseField           scSchdlField
#endif

#if !defined(DO_scSchdlFieldExists)
 #define scSchdlBaseFieldExists     scSchdlFieldExists
#endif

#if !defined(DO_scSchdlFieldName)
 #define scSchdlBaseFieldName       scSchdlFieldName
#endif

#if !defined(DO_scSchdlFields)
 #define scSchdlBaseFields          scSchdlFields
#endif

#if !defined(DO_scSchdlFilterCount)
 #define scSchdlBaseFilterCount     scSchdlFilterCount
#endif

#if !defined(DO_scSchdlFilterDelete)
 #define scSchdlBaseFilterDelete    scSchdlFilterDelete
#endif

#if !defined(DO_scSchdlFilterFetch)
 #define scSchdlBaseFilterFetch     scSchdlFilterFetch
#endif

#if !defined(DO_scSchdlFilterSelect)
 #define scSchdlBaseFilterSelect    scSchdlFilterSelect
#endif

#if !defined(DO_scSchdlGet)
 #define scSchdlBaseGet             scSchdlGet
#endif

#if !defined(DO_scSchdlInit)
 #define scSchdlBaseInit            scSchdlInit
#endif

#if !defined(DO_scSchdlInsert)
 #define scSchdlBaseInsert          scSchdlInsert
#endif

#if !defined(DO_scSchdlInstanceFieldList)
 #define scSchdlBaseInstanceFieldList  scSchdlInstanceFieldList
#endif

#if !defined(DO_scSchdlInstanceNotify)
 #define scSchdlBaseInstanceNotify  scSchdlInstanceNotify
#endif

#if !defined(DO_scSchdlInstanceOpen)
 #define scSchdlBaseInstanceOpen    scSchdlInstanceOpen
#endif

#if !defined(DO_scSchdlInstanceProtocol)
 #define scSchdlBaseInstanceProtocol scSchdlInstanceProtocol
#endif

#if !defined(DO_scSchdlInstanceSecurity)
 #define scSchdlBaseInstanceSecurity scSchdlInstanceSecurity
#endif

#if !defined(DO_scSchdlKey)
 #define scSchdlBaseKey             scSchdlKey
#endif

#if !defined(DO_scSchdlKeys)
 #define scSchdlBaseKeys            scSchdlKeys
#endif

#if !defined(DO_scSchdlName)
 #define scSchdlBaseName            scSchdlName
#endif

#if !defined(DO_scSchdlOpen)
 #define scSchdlBaseOpen            scSchdlOpen
#endif

#if !defined(DO_scSchdlOrder)
 #define scSchdlBaseOrder           scSchdlOrder
#endif

#if !defined(DO_scSchdlPost)
 #define scSchdlBasePost            scSchdlPost
#endif

#if !defined(DO_scSchdlPresents)
 #define scSchdlBasePresents        scSchdlPresents
#endif

#if !defined(DO_scSchdlProcess)
 #define scSchdlBaseProcess         scSchdlProcess
#endif

#if !defined(DO_scSchdlPut)
 #define scSchdlBasePut             scSchdlPut
#endif

#if !defined(DO_scSchdlRead)
 #define scSchdlBaseRead            scSchdlRead
#endif

#if !defined(DO_scSchdlReadLock)
 #define scSchdlBaseReadLock        scSchdlReadLock
#endif

#if !defined(DO_scSchdlRecordClear)
  #define scSchdlBaseRecordClear    scSchdlRecordClear
#endif

#if !defined(DO_scSchdlRecordGenerate)
  #define scSchdlBaseRecordGenerate scSchdlRecordGenerate
#endif

#if !defined(DO_scSchdlRevisionCancel)
 #define scSchdlBaseRevisionCancel  scSchdlRevisionCancel
#endif

#if !defined(DO_scSchdlRevisionExists)
 #define scSchdlBaseRevisionExists  scSchdlRevisionExists
#endif

#if !defined(DO_scSchdlRevisionPost)
 #define scSchdlBaseRevisionPost    scSchdlRevisionPost
#endif

#if !defined(DO_scSchdlRevisionRekey)
 #define scSchdlBaseRevisionRekey   scSchdlRevisionRekey
#endif

#if !defined(DO_scSchdlRevisionUnposted)
 #define scSchdlBaseRevisionUnposted scSchdlRevisionUnposted
#endif

#if !defined(DO_scSchdlSecurity)
 #define scSchdlBaseSecurity        scSchdlSecurity
#endif

#if !defined(DO_scSchdlTableEmpty)
 #define scSchdlBaseTableEmpty      scSchdlTableEmpty
#endif

#if !defined(DO_scSchdlType)
 #define scSchdlBaseType            scSchdlType
#endif

#if !defined(DO_scSchdlUnLock)
 #define scSchdlBaseUnLock          scSchdlUnLock
#endif

#if !defined(DO_scSchdlUpdate)
 #define scSchdlBaseUpdate          scSchdlUpdate
#endif

#if !defined(DO_scSchdlVerify)
 #define scSchdlBaseVerify          scSchdlVerify
#endif
...
#define scSchdlExtendedBaseAttribs           scSchdlBaseAttribs
#define scSchdlExtendedBaseBlkGet            scSchdlBaseBlkGet
#define scSchdlExtendedBaseBlkPut            scSchdlBaseBlkPut
#define scSchdlExtendedBaseBrowse            scSchdlBaseBrowse
#define scSchdlExtendedBaseCancel            scSchdlBaseCancel
#define scSchdlExtendedBaseClose             scSchdlBaseClose
#define scSchdlExtendedBaseCmpNames          scSchdlBaseCmpNames
#define scSchdlExtendedBaseCompose           scSchdlBaseCompose
#define scSchdlExtendedBaseCreate            scSchdlBaseCreate
#define scSchdlExtendedBaseDelete            scSchdlBaseDelete
#define scSchdlExtendedBaseDirty             scSchdlBaseDirty
#define scSchdlExtendedBaseDrop              scSchdlBaseDrop
#define scSchdlExtendedBaseExists            scSchdlBaseExists
#define scSchdlExtendedBaseFetch             scSchdlBaseFetch
#define scSchdlExtendedBaseFetchLock         scSchdlBaseFetchLock
#define scSchdlExtendedBaseField             scSchdlBaseField
#define scSchdlExtendedBaseFieldExists       scSchdlBaseFieldExists
#define scSchdlExtendedBaseFieldName         scSchdlBaseFieldName
#define scSchdlExtendedBaseFields            scSchdlBaseFields
#define scSchdlExtendedBaseFilterCount       scSchdlBaseFilterCount
#define scSchdlExtendedBaseFilterDelete      scSchdlBaseFilterDelete
#define scSchdlExtendedBaseFilterFetch       scSchdlBaseFilterFetch
#define scSchdlExtendedBaseFilterSelect      scSchdlBaseFilterSelect
#define scSchdlExtendedBaseGet               scSchdlBaseGet
#define scSchdlExtendedBaseInit              scSchdlBaseInit
#define scSchdlExtendedBaseInsert            scSchdlBaseInsert
#define scSchdlExtendedBaseInstanceFieldList scSchdlBaseInstanceFieldList
#define scSchdlExtendedBaseInstanceNotify    scSchdlBaseInstanceNotify
#define scSchdlExtendedBaseInstanceOpen      scSchdlBaseInstanceOpen
#define scSchdlExtendedBaseInstanceProtocol  scSchdlBaseInstanceProtocol
#define scSchdlExtendedBaseInstanceSecurity  scSchdlBaseInstanceSecurity
#define scSchdlExtendedBaseKey               scSchdlBaseKey
#define scSchdlExtendedBaseKeys              scSchdlBaseKeys
#define scSchdlExtendedBaseName              scSchdlBaseName
#define scSchdlExtendedBaseOpen              scSchdlBaseOpen
#define scSchdlExtendedBaseOrder             scSchdlBaseOrder
#define scSchdlExtendedBasePost              scSchdlBasePost
#define scSchdlExtendedBasePresents          scSchdlBasePresents
#define scSchdlExtendedBaseProcess           scSchdlBaseProcess
#define scSchdlExtendedBasePut               scSchdlBasePut
#define scSchdlExtendedBaseRead              scSchdlBaseRead
#define scSchdlExtendedBaseReadLock          scSchdlBaseReadLock
#define scSchdlExtendedBaseRecordClear       scSchdlBaseRecordClear
#define scSchdlExtendedBaseRecordGenerate    scSchdlBaseRecordGenerate
#define scSchdlExtendedBaseRevisionCancel    scSchdlBaseRevisionCancel
#define scSchdlExtendedBaseRevisionExists    scSchdlBaseRevisionExists
#define scSchdlExtendedBaseRevisionPost      scSchdlBaseRevisionPost
#define scSchdlExtendedBaseRevisionRekey     scSchdlBaseRevisionRekey
#define scSchdlExtendedBaseRevisionUnposted  scSchdlBaseRevisionUnposted
#define scSchdlExtendedBaseSecurity          scSchdlBaseSecurity
#define scSchdlExtendedBaseTableEmpty        scSchdlBaseTableEmpty
#define scSchdlExtendedBaseType              scSchdlBaseType
#define scSchdlExtendedBaseUnLock            scSchdlBaseUnLock
#define scSchdlExtendedBaseUpdate            scSchdlBaseUpdate
#define scSchdlExtendedBaseVerify            scSchdlBaseVerify

#else

VIEWCALL scSchdlBaseAttribs (LPVOID lpView, LONG lField, LPLONG lpAttributes)
{
   ERRNUM e = scSchdlExtendedBaseAttribs (lpView, lField, lpAttributes);
...
VIEWCALL scSchdlBaseBlkGet (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer)
{
   ERRNUM e = scSchdlExtendedBaseBlkGet (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer);
...
VIEWCALL scSchdlBaseBlkPut (LPVOID lpView, INT lFields, LPLONG lFieldList, LPSHORT lpnSizeList, LPSTR lpsBuffer, BOOL bVerify)
{
   ERRNUM e = scSchdlExtendedBaseBlkPut (lpView, lFields, lFieldList, lpnSizeList, lpsBuffer, bVerify);
...
VIEWCALL scSchdlBaseBrowse (LPVOID lpView, LPSTR lpsExpression, BOOL bAscending)
{
   ERRNUM e = scSchdlExtendedBaseBrowse (lpView, lpsExpression, bAscending);
...
VIEWCALL scSchdlBaseCancel (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseCancel (lpView);
...
VIEWCALL scSchdlBaseClose (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseClose (lpView);
...
VIEWCALL scSchdlBaseCmpNames (INT roto, LPSTR lpsCompositeNames, LPSHORT lpnCount)
{
   ERRNUM e = scSchdlExtendedBaseCmpNames (roto, lpsCompositeNames, lpnCount);
...
VIEWCALL scSchdlBaseCompose (LPVOID lpView, LPVIEWDEF lpvdefComposites)
{
   ERRNUM e = scSchdlExtendedBaseCompose (lpView, lpvdefComposites);
...
VIEWCALL scSchdlBaseCreate (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scSchdlExtendedBaseCreate (hPIB, wLinkNo);
...
VIEWCALL scSchdlBaseDelete (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseDelete (lpView);
...
VIEWCALL scSchdlBaseDirty (LPVOID lpView, LPBOOL bChanged)
{
   ERRNUM e = scSchdlExtendedBaseDirty (lpView, bChanged);
...
VIEWCALL scSchdlBaseDrop (HPIB hPIB, WORD wLinkNo)
{
   ERRNUM e = scSchdlExtendedBaseDrop (hPIB, wLinkNo);
...
VIEWCALL scSchdlBaseExists (LPVOID lpView, LPBOOL bExists)
{
   ERRNUM e = scSchdlExtendedBaseExists (lpView, bExists);
...
VIEWCALL scSchdlBaseFetch (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseFetch (lpView);
...
VIEWCALL scSchdlBaseFetchLock (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseFetchLock (lpView);
...
VIEWCALL scSchdlBaseField (LPVOID lpView, INT nFldNumber, LPSTR lpsFldName, LPLONG lField)
{
   ERRNUM e = scSchdlExtendedBaseField (lpView, nFldNumber, lpsFldName, lField);
...
VIEWCALL scSchdlBaseFieldExists (LPV view, LONG lField, LP_A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseFieldExists (view, lField, flags);
...
VIEWCALL scSchdlBaseFieldName (LPV view, LONG lField, LPSTR lpsName, LPSTR lpsDesc, A4W_SIZE size)
{
   ERRNUM e = scSchdlExtendedBaseFieldName (view, lField, lpsName, lpsDesc, size);
...
VIEWCALL scSchdlBaseFields (LPVOID lpView, LPSHORT lFields)
{
   ERRNUM e = scSchdlExtendedBaseFields (lpView, lFields);
...
VIEWCALL scSchdlBaseFilterCount (LPV view, LPSTR filter, A4W_FLAGS flags, LP_A4W_SIZE count)
{
   ERRNUM e = scSchdlExtendedBaseFilterCount (view, filter, flags, count);
...
VIEWCALL scSchdlBaseFilterDelete (LPV view, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseFilterDelete (view, filter, flags);
...
VIEWCALL scSchdlBaseFilterFetch (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseFilterFetch (view, flags);
...
VIEWCALL scSchdlBaseFilterSelect (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseFilterSelect (view, key, filter, flags);
...
VIEWCALL scSchdlBaseGet (LPVOID lpView, LONG lField, LPSTR buffer, INT nSize)
{
   ERRNUM e = scSchdlExtendedBaseGet (lpView, lField, buffer, nSize);
...
VIEWCALL scSchdlBaseInit (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseInit (lpView);
...
VIEWCALL scSchdlBaseInsert (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseInsert (lpView);
...
VIEWCALL scSchdlBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = scSchdlExtendedBaseInstanceFieldList (view, flags, count, fields);
...
VIEWCALL scSchdlBaseInstanceNotify (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseInstanceNotify (view, notify, context, flags);
...
VIEWCALL scSchdlBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
   ERRNUM e = scSchdlExtendedBaseInstanceOpen (rvh, PIB, link, flags, extra, size, view);
...
VIEWCALL scSchdlBaseInstanceProtocol (LPV view, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = scSchdlExtendedBaseInstanceProtocol (view, flags, protocols, count);
...
VIEWCALL scSchdlBaseInstanceSecurity (LPV view, LP_A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseInstanceSecurity (view, flags);
...
VIEWCALL scSchdlBaseKey (LPVOID lpView, INT nKeyNo, LPSTR sName, LPSHORT lFields, LPLONG lplKeyFields)
{
   ERRNUM e = scSchdlExtendedBaseKey (lpView, nKeyNo, sName, lFields, lplKeyFields);
...
VIEWCALL scSchdlBaseKeys (LPVOID lpView, LPSHORT lpnKeys)
{
   ERRNUM e = scSchdlExtendedBaseKeys (lpView, lpnKeys);
...
VIEWCALL scSchdlBaseName (LPVOID lpView, LONG lField, LPSTR lpsName, LPSTR lpsDesc)
{
   ERRNUM e = scSchdlExtendedBaseName (lpView, lField, lpsName, lpsDesc);
...
VIEWCALL scSchdlBaseOpen (HPIB hPIB, WORD wLinkNo, LPVOID FAR * lpView)
{
   ERRNUM e = scSchdlExtendedBaseOpen (hPIB, wLinkNo, lpView);
...
VIEWCALL scSchdlBaseOrder (LPVOID lpView, INT nKey)
{
   ERRNUM e = scSchdlExtendedBaseOrder (lpView, nKey);
...
VIEWCALL scSchdlBasePost (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBasePost (lpView);
...
VIEWCALL scSchdlBasePresents (LPVOID lpView, LONG lField, LPSTR lpsMask, LPSHORT lpnList, LPSHORT lpnCount, LPVOID lpBuffer, INT nSize)
{
   ERRNUM e = scSchdlExtendedBasePresents (lpView, lField, lpsMask, lpnList, lpnCount, lpBuffer, nSize);
...
VIEWCALL scSchdlBaseProcess (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseProcess (lpView);
...
VIEWCALL scSchdlBasePut (LPVOID lpView, LONG lField, LPSTR lpsBuffer, INT nSize, BOOL bVerify)
{
   ERRNUM e = scSchdlExtendedBasePut (lpView, lField, lpsBuffer, nSize, bVerify);
...
VIEWCALL scSchdlBaseRead (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseRead (lpView);
...
VIEWCALL scSchdlBaseReadLock (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseReadLock (lpView);
...
VIEWCALL scSchdlBaseRecordClear (LPV view)
{
   ERRNUM e = scSchdlExtendedBaseRecordClear (view);
...
VIEWCALL scSchdlBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseRecordGenerate (view, flags);
...
VIEWCALL scSchdlBaseRevisionCancel (LPV view, INT level)
{
   ERRNUM e = scSchdlExtendedBaseRevisionCancel (view, level);
...
VIEWCALL scSchdlBaseRevisionExists (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseRevisionExists (view, level, flags);
...
VIEWCALL scSchdlBaseRevisionPost (LPV view, INT level)
{
   ERRNUM e = scSchdlExtendedBaseRevisionPost (view, level);
...
VIEWCALL scSchdlBaseRevisionRekey (LPV view, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseRevisionRekey (view, OldKey, NewKey, size, flags);
...
VIEWCALL scSchdlBaseRevisionUnposted (LPV view, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = scSchdlExtendedBaseRevisionUnposted (view, level, flags);
...
VIEWCALL scSchdlBaseSecurity (HPIB hPIB, WORD wLinkNo, LPLONG lplPermissions)
{
   ERRNUM e = scSchdlExtendedBaseSecurity (hPIB, wLinkNo, lplPermissions);
...
VIEWCALL scSchdlBaseTableEmpty (LPV view)
{
   ERRNUM e = scSchdlExtendedBaseTableEmpty (view);
...
VIEWCALL scSchdlBaseType (LPVOID lpView, LONG lField, LPTYPE lptype)
{
   ERRNUM e = scSchdlExtendedBaseType (lpView, lField, lptype);
...
VIEWCALL scSchdlBaseUnLock (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseUnLock (lpView);
...
VIEWCALL scSchdlBaseUpdate (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseUpdate (lpView);
...
VIEWCALL scSchdlBaseVerify (LPVOID lpView)
{
   ERRNUM e = scSchdlExtendedBaseVerify (lpView);
...
VIEWCALL rotoEntryBase (LPROTOVIEW v, INT length)
{
   ...
   switch ( v->op ) {
      case VIEW_OP_ATTRIBUTES :
         e = scSchdlAttribs (v->view, MapToNewFieldIndex (v->field), (LPLONG) v->p);
         break;
      case VIEW_OP_BLKGET :
         e = scSchdlBlkGet (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r);
         break;
      case VIEW_OP_BLKPUT :
         e = scSchdlBlkPut (v->view, v->i, (LPLONG) v->p, (LPSHORT) v->q, (LPSTR) v->r, v->flag);
         break;
      case VIEW_OP_BROWSE :
         e = scSchdlBrowse (v->view, (LPSTR) v->p, v->flag);
         break;
      case VIEW_OP_CANCEL :
         e = scSchdlCancel (v->view);
         break;
      case VIEW_OP_CLOSE :
         e = scSchdlClose (v->view);
         break;
      case VIEW_OP_COMPOSE :
         e = scSchdlCompose (v->view, (LPVIEWDEF) v->p);
         break;
      case VIEW_OP_COMPOSITES :
         e = scSchdlCmpNames (v->i, (LPSTR) v->p, (LPSHORT) v->q);
         break;
      case VIEW_OP_CREATE :
         e = scSchdlCreate (v->i, v->x);
         break;
      case VIEW_OP_DELETE :
         e = scSchdlDelete (v->view);
         break;
      case VIEW_OP_DIRTY :
         e = scSchdlDirty (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_DROP :
         e = scSchdlDrop (v->i, v->x);
         break;
      case VIEW_OP_EXISTS :
         e = scSchdlExists (v->view, (LPBOOL) v->p);
         break;
      case VIEW_OP_FETCH :
         e = scSchdlFetch (v->view);
         break;
      case VIEW_OP_FETCH_LOCK :
         e = scSchdlFetchLock (v->view);
         break;
      case VIEW_OP_FIELD :
         e = scSchdlField (v->view, v->i, (LPSTR) v->p, (LPLONG) v->q);
         break;
      case VIEW_OP_FIELD_EXISTS :
         e = scSchdlFieldExists ((LPV) v->view, v->field, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_FIELD_NAME :
         e = scSchdlFieldName ((LPV) v->view, v->field, (LPSTR) v->p, (LPSTR) v->q, v->i);
         break;
      case VIEW_OP_FIELDS :
         e = scSchdlFields (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_FILTER_COUNT :
         e = scSchdlFilterCount ((LPV) v->view, (LPSTR) v->p, v->dw, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_FILTER_DELETE :
         e = scSchdlFilterDelete ((LPV) v->view, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_FILTER_FETCH :
         e = scSchdlFilterFetch ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_FILTER_SELECT :
         e = scSchdlFilterSelect ((LPV) v->view, v->i, (LPSTR) v->p, v->dw);
         break;
      case VIEW_OP_GET :
         e = scSchdlGet (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i);
         break;
      case VIEW_OP_INITIALIZE :
         e = scSchdlInit (v->view);
         break;
      case VIEW_OP_INSERT :
         e = scSchdlInsert (v->view);
         break;
      case VIEW_OP_INSTANCE_FIELDLIST :
         e = scSchdlInstanceFieldList ((LPV) v->view, v->dw, v->i, (PLONG) v->p);
         break;
      case VIEW_OP_INSTANCE_NOTIFY :
         e = scSchdlInstanceNotify ((LPV) v->view, (A4W_NOTIFY_PROC) v->p, v->q, v->dw);
         break;
      case VIEW_OP_INSTANCE_OPEN :
#if defined(DO_OPENETC) || !defined(DO_scSchdlOpen) || defined(DO_scSchdlInstanceOpen)
         e = scSchdlInstanceOpen ((LPRVH) v->p, v->i, v->x, v->dw,
                               v+1, length-sizeof (ROTOVIEW), (LPV *) &v->view);
#else
         e = scSchdlOpen (v->i, v->x, &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scSchdlInstanceOpen() is redirected to scSchdlOpen() because scSchdlOpen() is")
  #warning ("overridden, scSchdlInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #warning ("loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scSchdlInstanceOpen() is redirected to scSchdlOpen() because scSchdlOpen() is")
  #pragma message ("overridden, scSchdlInstanceOpen() isn't, and OpenEtc() isn't used. To avoid this")
  #pragma message ("loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_INSTANCE_PROTOCOL :
         e = scSchdlInstanceProtocol ((LPV) v->view, v->dw, (LP_A4W_FLAGS) v->p, (LP_A4W_SIZE) v->q);
         break;
      case VIEW_OP_INSTANCE_SECURITY :
         e = scSchdlInstanceSecurity ((LPV) v->view, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_KEY :
         e = scSchdlKey (v->view, v->i, (LPSTR) v->p, (LPSHORT) v->q, (LPLONG) v->r);
         break;
      case VIEW_OP_KEYS :
         e = scSchdlKeys (v->view, (LPSHORT) v->p);
         break;
      case VIEW_OP_NAME :
         e = scSchdlName (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, (LPSTR) v->q);
         break;
      case VIEW_OP_OPEN :
#if defined(DO_OPENETC) || defined(DO_scSchdlOpen) || !defined(DO_scSchdlInstanceOpen)
         e = scSchdlOpen (v->i, v->x, &v->view);
#else
         e = scSchdlInstanceOpen (NULL, v->i, v->x, 0L, NULL, 0, (LPV *) &v->view);
 #if defined LINUX_VER
  #warning ("WARNING: scSchdlOpen() is redirected to scSchdlInstanceOpen() because")
  #warning ("scSchdlInstanceOpen() is overridden, scSchdlOpen() isn't, and OpenEtc() isn't used.")
  #warning ("To avoid this loss of functionality move the override code into OpenEtc()")
 #else
  #pragma message ("WARNING: scSchdlOpen() is redirected to scSchdlInstanceOpen() because")
  #pragma message ("scSchdlInstanceOpen() is overridden, scSchdlOpen() isn't, and OpenEtc() isn't used.")
  #pragma message ("To avoid this loss of functionality move the override code into OpenEtc()")
 #endif
#endif
         break;
      case VIEW_OP_ORDER :
         e = scSchdlOrder (v->view, v->i);
         break;
      case VIEW_OP_POST :
         e = scSchdlPost (v->view);
         break;
      case VIEW_OP_PRESENTATION :
         e = scSchdlPresents (v->view, MapToNewFieldIndex (v->field),
                           (LPSTR) v->p, (LPSHORT) v->q, (LPSHORT) v->r, v->s, v->i);
         break;
      case VIEW_OP_PROCESS :
         e = scSchdlProcess (v->view);
         break;
      case VIEW_OP_PUT :
         e = scSchdlPut (v->view, MapToNewFieldIndex (v->field), (LPSTR) v->p, v->i, v->flag);
         break;
      case VIEW_OP_READ :
         e = scSchdlRead (v->view);
         break;
      case VIEW_OP_READ_LOCK :
         e = scSchdlReadLock (v->view);
         break;
      case VIEW_OP_RECORD_CLEAR :
         e = scSchdlRecordClear ((LPV) v->view);
         break;
      case VIEW_OP_RECORD_GENERATE :
         e = scSchdlRecordGenerate ((LPV) v->view, v->dw);
         break;
      case VIEW_OP_REVISION_CANCEL :
         e = scSchdlRevisionCancel ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_EXISTS :
         e = scSchdlRevisionExists ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_REVISION_POST :
         e = scSchdlRevisionPost ((LPV) v->view, v->i);
         break;
      case VIEW_OP_REVISION_REKEY :
         e = scSchdlRevisionRekey ((LPV) v->view, v->p, v->q, v->i, v->dw);
         break;
      case VIEW_OP_REVISION_UNPOSTED :
         e = scSchdlRevisionUnposted ((LPV) v->view, v->i, (LP_A4W_FLAGS) v->p);
         break;
      case VIEW_OP_SECURITY :
         e = scSchdlSecurity (v->i, v->x, (LPLONG) v->p);
         break;
      case VIEW_OP_TABLE_EMPTY :
         e = scSchdlTableEmpty ((LPV) v->view);
         break;
//////////////////////////////////////////////////////////////////////////////
// Experimental stuff
      case VIEW_OP_TABLE_HANDLES :
         e = scSchdlTableHandles ((LPV) v->view, v->i, (LPWORD) v->p);
         break;
//////////////////////////////////////////////////////////////////////////////
      case VIEW_OP_TYPE :
         e = scSchdlType (v->view, MapToNewFieldIndex (v->field), (LPTYPE) v->p);
         break;
      case VIEW_OP_UNLOCK :
         e = scSchdlUnLock (v->view);
         break;
      case VIEW_OP_UPDATE :
         e = scSchdlUpdate (v->view);
         break;
      case VIEW_OP_VERIFY :
         e = scSchdlVerify (v->view);
         break;
      default :
...
VIEWCALL identifyEntry (LPIDENTIFYVIEW identify, INT length)
{
   switch ( identify->op ) {
      case IDENTIFY_OP_VERSION_TEMPLATE:
         return scSchdlVersionTemplate (identify->pib, identify->TextDatum, (LPBCDDATE) identify->BinaryDatum);
      case IDENTIFY_OP_VERSION_API:
         return scSchdlVersionAPI (identify->pib, identify->TextDatum);
      case IDENTIFY_OP_VIEW_NAME:
         return scSchdlViewName (identify->pib, identify->TextDatum, identify->TextLength);
      case IDENTIFY_OP_VIEW_TABLE_COUNT:
         return scSchdlViewTableCount (identify->pib, (LPSHORT) identify->BinaryDatum);
      case IDENTIFY_OP_VIEW_TABLES:
         return scSchdlViewTables (identify->pib, identify->TextDatum, identify->TextLength);
      default:
...
/*--------------------------------------------------------------------
   ...
   can change.
*/
VIEWCALL scSchdlExtendedBaseAttribs (
   LPVOID lpView,
   LONG nField,
...
/*--------------------------------------------------------------------
   ...
   can be used in place of several scSchdlGet calls to minimize the
   number of view calls.
*/
VIEWCALL scSchdlExtendedBaseBlkGet (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scSchdlGet (lpView, field, &lpsBuffer[nPos], size));
#else
...
/*--------------------------------------------------------------------
   ...
   of several scSchdlPut calls to minimize the number of view calls.
*/
VIEWCALL scSchdlExtendedBaseBlkPut (
   LPVOID lpView,
   INT nFields,
   LPLONG lplFieldList,
   LPSHORT lpnSizeList,
...
#if SUBCLASS_LEVEL==NOT_SUBCLASS || defined(DO_OLDSUBCLASSFIELDBLK)
      CHECK_CALL (e, scSchdlPut (lpView, field, &lpsBuffer[nPos], size, bVerify));
#else
      if ( ValidIndexV (lpv, field) ) {
         BASE_BLK_PUT();
         nPosSub = nPos + size;
...
/*--------------------------------------------------------------------
   ...
   and direction for subsequent scSchdlRead and scSchdlFetch calls. The
   key to start from is specified by the current contents of the
   logical record.
*/
VIEWCALL scSchdlExtendedBaseBrowse (
   LPVOID lpView,
   LPSTR lpsExpression,
   BOOL bAscending)
{
...
/*--------------------------------------------------------------------
   ...
   conjunction with scSchdlPost.
*/
VIEWCALL scSchdlExtendedBaseCancel (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   Closes an open view.
*/
VIEWCALL scSchdlExtendedBaseClose (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   INT nTbl;
...
/*--------------------------------------------------------------------
   ...
   compose. If lpsCompositeNames is a null address, scSchdlCmpNames will
   not return the list of view rotoIDS. Instead, scSchdlCmpNames will
   return the size of the buffer required to hold the sequence of
   character strings in *lpnCount.
*/
VIEWCALL scSchdlExtendedBaseCmpNames (
   INT roto,
...
*/
VIEWCALL scSchdlExtendedBaseCompose (
   LPVOID lpView,
...
*/
VIEWCALL scSchdlExtendedBaseCreate (
   HPIB hPIB,
   WORD wLinkNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scSchdlExtendedBaseDelete (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Reports whether fields have been altered with scSchdlPut calls.
*/
VIEWCALL scSchdlExtendedBaseDirty (
   LPVOID lpView,
   LPBOOL lpbChanged)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Deletes tables created by scSchdlCreate from the database denoted by
   wLinkNo. You should not currently be in a transaction when
   calling this function.
*/
VIEWCALL scSchdlExtendedBaseDrop (
   HPIB hPIB,
   WORD wLinkNo)
{
...
*/
VIEWCALL scSchdlExtendedBaseExists (
   LPVOID lpView,
   LPBOOL lpbExists)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   filter set in the last scSchdlBrowse call.
*/
VIEWCALL scSchdlExtendedBaseFetch (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   Retrieves the next logical record according to the direction and
   filter set in the last scSchdlBrowse call. scSchdlFetchLock is the
   same as scSchdlFetch except that the record is locked.
*/
VIEWCALL scSchdlExtendedBaseFetchLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scSchdlExtendedBaseField (
   LPVOID lpView,
   INT nFldNumber,
   LPSTR lpsFldName,
   LPLONG lplField)
...
*/
VIEWCALL scSchdlExtendedBaseFieldExists (
   LPV view,
   LONG lField,
   LP_A4W_FLAGS flags)
{
...
*/
VIEWCALL scSchdlExtendedBaseFieldName (
   LPV view,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc,
...
*/
VIEWCALL scSchdlExtendedBaseFields (
   LPVOID lpView,
   LPSHORT lpnFields)
{
   if ( SUBCLASS_LEVEL==NOT_SUBCLASS ) {
...
VIEWCALL scSchdlExtendedBaseFilterCount (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags,
   LP_A4W_SIZE count)
{
   ...
   if ( expression==NULL ) {
      ...
      f = filterExprSegments (lpv, &lpv->filter, lpv->wDetailFilterSegments,
                              (FILTERNAME) xxxNameOnly, (FILTERGET) scSchdlGet, &range);
      RVSPYTRACE (range);
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, range, &filter, (FILTERFIELD) scSchdlField, (FILTERFIELDS) scSchdlFields, (FILTERTYPE) scSchdlType);
...
*/
VIEWCALL scSchdlExtendedBaseFilterDelete (
   LPV lpv,
   LPSTR expression,
   A4W_FLAGS flags)
{
...
VIEWCALL scSchdlExtendedBaseFilterFetch       (LPV lpv, A4W_FLAGS flags)
{
...
VIEWCALL scSchdlExtendedBaseFilterSelect     (LPV view, INT key, LPSTR filter, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   ...
   CHECK_CALL (e, scSchdlOrder (view, key));
   CHECK_CALL (e, scSchdlBrowse (view, filter, ascending));
   return e;
}
...
*/
VIEWCALL scSchdlExtendedBaseGet (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsBuffer,
   INT nSize)
{
   ...
   if ( lField==DIRTY_IDX ) {
      ...
      CHECK_CALL (e, scSchdlRevisionUnposted (lpv, 1+HDR_HAS_REVISIONS, &flags));
...
/*--------------------------------------------------------------------
   ...
   field in a view.
*/
VIEWCALL scSchdlExtendedBaseInit (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   record is not added.
*/
VIEWCALL scSchdlExtendedBaseInsert (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==SEQUENCE_REVISIONS && GENERATEKEY_NONE==lpv->bKeyGenerated ) {
      ...
      // of its details, the key must have been generated via scSchdlRecordGenerate()
      int c;
...
VIEWCALL scSchdlExtendedBaseInstanceFieldList (LPV view, A4W_FLAGS flags, A4W_SIZE count, PLONG fields)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseInstanceNotify   (LPV view, A4W_NOTIFY_PROC notify, LPVOID context, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseInstanceOpen (LPRVH rvh, HPIB PIB, WORD link, A4W_FLAGS flags, LPVOID extra, A4W_SIZE size, LPV FAR * view)
{
...
VIEWCALL scSchdlExtendedBaseInstanceProtocol (LPV lpv, A4W_FLAGS flags, LP_A4W_FLAGS protocols, LP_A4W_SIZE count)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseInstanceSecurity (LPV lpv, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   information
*/
VIEWCALL scSchdlExtendedBaseKey (
   LPVOID lpView,
   INT nKeyNo,
   LPSTR lpsName,
   LPSHORT lpnFields,
...
/*--------------------------------------------------------------------
   ...
   conjunction with scSchdlKey to retrieve information about key
   structure.
*/
VIEWCALL scSchdlExtendedBaseKeys (
   LPVOID lpView,
   LPSHORT lpnKeys)
{
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scSchdlExtendedBaseName (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsName,
   LPSTR lpsDesc)
...
*/
VIEWCALL scSchdlExtendedBaseOpen (
   HPIB hPIB,
   WORD wLinkNo,
   LPVOID FAR * lplpView)
{
...
*/
VIEWCALL scSchdlExtendedBaseOrder (
   LPVOID lpView,
   INT nKeyNo)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scSchdlExtendedBasePost (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
   ...
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scSchdlPost is no longer supported on non-revisioned views.");
   }
#endif
...
*/
VIEWCALL scSchdlExtendedBasePresents (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsMask,
   LPSHORT lpnList,
...
*/
VIEWCALL scSchdlExtendedBaseProcess (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
   ERRNUM e = ERRNUM_SUCCESS;
...
*/
VIEWCALL scSchdlExtendedBasePut (
   LPVOID lpView,
   LONG lField,
   LPSTR lpsBuffer,
   INT nSize,
   ...
   if ( (* comparator) (f, (LPDATUM) target, (LPDATUM) normalized)!=0 ) {
      ...
      if ( attribs & ATTR_KEY ) {
         ...
         blkSet ((FindRecord (lpv)) [BASE_TBL_COUNT] +
                  FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCSCHDL_FLD_AUDIT].wOffset,
                 ' ', sizeof (AUDITSTAMP));
#endif
         if ( SUBCLASS_LEVEL!=NOT_SUBCLASS ) {
            CHECK_CALL (e, BaseBrowse (lpv, FALSE));
...
*/
VIEWCALL scSchdlExtendedBaseRead (
   LPVOID lpView)
{
...
/*--------------------------------------------------------------------
   Fetches the logical record index by the current contents of the
   view's key fields. If there are composite views, the caller is
   responsible for reading them in as well. scSchdlReadLock is the
   same as scSchdlRead except that the record is locked.
*/
VIEWCALL scSchdlExtendedBaseReadLock (
   LPVOID lpView)
{
...
VIEWCALL scSchdlExtendedBaseRecordClear (LPV view)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseRecordGenerate (LPV view, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseRevisionCancel   (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseRevisionExists   (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
...
VIEWCALL scSchdlExtendedBaseRevisionPost     (LPV lpv, INT level)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
   REV_ERRNUM r = POST_DONE;
...
#if !(defined(DETAIL_VIEW) || defined(SUPER_VIEW))
   if ( HAS_REVISIONS==NO_REVISIONS ) {
      rvspyTrace ("WARNING: scSchdlRevisionPost is no longer supported on non-revisioned views.");
   }
#endif
...
VIEWCALL scSchdlExtendedBaseRevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlExtendedBaseRevisionUnposted (LPV lpv, INT level, LP_A4W_FLAGS flags)
{
   ERRNUM e = ERRNUM_SUCCESS;
   BOOL dirty = FALSE;
...
/*--------------------------------------------------------------------
   ...
   given database link.
*/
VIEWCALL scSchdlExtendedBaseSecurity (
   HPIB hPIB,
   WORD wLinkNo,
...
*/
VIEWCALL scSchdlExtendedBaseTableEmpty (LPV lpv)
{
   ERRNUM e = ERRNUM_SUCCESS;
   DB_ERRNUM d = DBS_SUCCESS;
...
/*--------------------------------------------------------------------
   ...
   varies by type.
*/
VIEWCALL scSchdlExtendedBaseType (
   LPVOID lpView,
   LONG nField,
   LPTYPE lptype)
{
...
/*--------------------------------------------------------------------
   Unlocks the logical record locked by the scSchdlFetchLock or the
   scSchdlReadLock calls.
*/
VIEWCALL scSchdlExtendedBaseUnLock (
   LPVOID lpView)
{
   LPV lpv = (LPV) lpView;
...
/*--------------------------------------------------------------------
   ...
   been altered; if they are use the scSchdlInsert routine instead.
*/
VIEWCALL scSchdlExtendedBaseUpdate (
   LPVOID lpView)
{
   ERRNUM e = ERRNUM_SUCCESS;
   LPV lpv = (LPV) lpView;
...
*/
VIEWCALL scSchdlExtendedBaseVerify (
   LPVOID lpView)
{
...
VIEWBASE xxxFetchFilterBase (LPV lpv, INT flags, LPFILTER filter, LPSHORT range, BOOL ascending)
{
   ...
   if ( !started ) {
      ...
      f = filterInitRange (lpv, filter, ascending, range,
                           (FILTERGET) scSchdlGet, (FILTERPUT) scSchdlPut);
   ...
   for (;;) {
      ...
      switch ( d ) {
         ...
         case DBS_CVIEW_WARNING:
            ...
            f = filterEval (lpv, (FILTERGET) scSchdlGet, filter, ascending, *range);
            switch ( f ) {
               case FL_SUCCESS:
                  goto RecordFound;
               case FL_FAIL:
      ...
      if ( f==FL_END_OF_RANGE || d==DBS_NO_MORE_DATA ) {
         ...
         f = filterPutRange (lpv, filter, ascending, *range, (FILTERPUT) scSchdlPut);
         if ( FL_ERRNUM_IS_FAILURE (f) )
            goto ReturnFilterError;
         if ( DB_ERRNUM_IS_FAILURE (d) )
            d = DBS_SUCCESS;
...
VIEWCALL xxxKey (
   ...
   LPSHORT lpnFields,
   LPLONG lplKeyFields)
// Call gate for scSchdlKey, intended for use by the filter* routines.
// It Suppresses reporting of boundary errors, though others may be reported.
{
   ...
   *lpnFields = 0;
   ...
   MaxError (&e, scSchdlKey (lpView, nKeyNo, lpsName, lpnFields, lplKeyFields));
   return e;
}
...
#define VALIDATE(__expr__) {          \
   ...
   if ( lpv->bVerified ) {
      ...
      CHECK_CALL_GOTO (e, protocol_error, scSchdlDirty (lpView, &dirty));
#endif
      if ( !dirty )
          return ERRNUM_SUCCESS;
   }
   ...
   if ( SUBCLASS_LEVEL!=NOT_SUBCLASS && verifying && VIEW_OP (lpv, OPEN)==VIEW_OP_VERIFY ) {
      // Only propagate verification if scSchdlVerify really was called
...
VIEWBASE BrowseBody (LPV lpv, LPSTR expression, BOOL ascending)
{
   ...
   op = FILTER_OP_PARSE;
   f = filterParse (lpv, expression, &lpv->filter, (FILTERFIELD) scSchdlField,
                    (FILTERFIELDS) scSchdlFields, (FILTERTYPE) scSchdlType);
   CHECK_CALL (e, ErrorMapFilterToExtended (op, filterErrorV (lpv, op, f)));
...
// scSchdlFilterDelete(), along with all its limitations. In particular,
   ...
   INT nSize)
{
   ...
   if ( nSize!=sizeof(etag) )
   {
      ReportError (lpv, (RSCID)IDERR_SC_BUFFER_MSG,
                   MAKERSC(IDS_SCSCHDL_VIEW_NOUN), "ETAG", NULL);
      return ERRNUM_MEMORY_BUFFER_LIMIT;
   }
   ...
   if ( HAS_DATABASE_TABLES )
   {
      ...
      lpadt = (LPAUDITSTAMP) (FindRecord (lpv) [BASE_TBL_COUNT] +
                              FindTableMap (BASE_TBL_COUNT)->fields[SCSCHDL_FLD_AUDIT].wOffset);
   }
   else
   {
      DBDATE dbDate;
...
VIEWBASE GenerateKeyReally (LPV lpv)
{
   ...
   INT primary = FindTableMapV (lpv, BASE_TBL_COUNT)->fields[SCSCHDL_FLD_AUDIT].wOffset;
...
A4W_FLAGS WINAPI GetPermissions (LPV lpv)
{
   ...
   e = scSchdlInstanceSecurity (lpv, &permissions);
   if ( ERRNUM_IS_FAILURE (e) )
      permissions = 0;
   return permissions;
}
...
VIEWBASE InitBodyGenBase (LPV lpv, INT fGenerate)
{
   ...
   if ( insert ) {
      CHECK_CALL (e, scSchdlInsert (lpv));
   }
   return e;
}
...
// This function should NEVER be called from scSchdlPost or scSchdlCancel entrypoints
...
VIEWBASE NotifyClose (LPV lpv)
{
   ...
   for ( c=0; c<EXP_CMP_COUNT; ++c ) {
      ...
      if ( (d && (d->options & CMPNAME_OPTION_NOTIFY)) ||
         ...
         // scSchdlClose, so we have to try to clear away everything.
      }
   }
...
#if defined(SCSCHDL_ROTOID)
   utlObjStrToID (SCSCHDL_ROTOID, &lpv->rotoID);
#endif
      ...
      switch ( e ) {
         ...
         case ERRNUM_OPEN_FAILED:
            ReportError (lpv, (RSCID)IDERR_SC_VIEWOPEN_MSG,
                         MAKERSC(IDS_SCSCHDL_VIEW_NOUN), NULL, NULL);
            break;
...
#define REPORT_USE_ERROR(v,e,f) \
   ReportError ((v), (RSCID)(e), MAKERSC(IDS_SCSCHDL_VIEW_NOUN), \
...
void WINAPI ReportBaseLoadError (HPIB hpib, LPSTR rotoID)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_VIEWLOAD_MSG,
                      MAKERSC(IDS_SCSCHDL_VIEW_NOUN), rotoID, NULL);
}
...
void WINAPI ReportBaseMemoryError (HPIB hpib, RSCID op)
{
   ReportErrorViaPIB (hpib, (RSCID)IDERR_SC_MEMORY_MSG,
                      MAKERSC(IDS_SCSCHDL_VIEW_NOUN), MAKERSC(op), NULL);
}
...
void WINAPI ReportCompositeKeyError (LPV lpv, RSCID op, LPSTR rotoID)
{
   ReportError (lpv, (RSCID)IDERR_SC_CMPKEY_MSG,
                MAKERSC(IDS_SCSCHDL_VIEW_NOUN), MAKERSC(op), rotoID);
}
...
void WINAPI ReportFieldError (LPV lpv, INT field)
{
   ...
   ReportError (lpv, (RSCID)IDERR_SC_FLDNUM_MSG,
                MAKERSC(IDS_SCSCHDL_VIEW_NOUN), value, NULL);
}
...
{
   errPutGeneric (lpv->hpib, APPL, MAKERSC (IDS_SCSCHDL_VIEW_NOUN), NULL,
...
{
   errPutGeneric (pib, APPL, MAKERSC(IDS_SCSCHDL_VIEW_NOUN), NULL,
                  area, op, MAKERSC (ERRGEN_CAT_DEFAULT), error, extra);
}
...
void WINAPI ReportString (LPSTR message)
{
   ...
   buffer[0] = 0;
#if defined(SCSCHDL_ROTOID)
   strCopy (buffer, SCSCHDL_ROTOID);
   strAppend (buffer, ": ");
#endif
   strAppend (buffer, "<SCSCHDL> ");
...
void WINAPI ScratchError (LPV lpv)
{
   ...
   rscLoadText (lpv->hpib, APPL, IDS_SCSCHDL_VIEW_NOUN, noun, sizeof (noun));
...
ERRNUM SelectionIncrease (LPV lpv, A4W_FLAGS what, A4W_SIZE count, PLONG fields)
{
   ...
   if ( TBL_COUNT>0 && (what & SELECTION_AUDIT_STAMP) ) {
      ...
      def += SCSCHDL_FLD_AUDIT; // AUDTDATE
...
// UNDER
{
   ...
   RVSPYINDENT (1);
   if ( !lpv->bRevisioned ) {
      ERRNUM e = scSchdlDirty (lpv, dirty);
...
DB_ERRNUM WINAPI RevisionRekey (LPV lpv, LPVOID OldKey, LPVOID NewKey, INT size, A4W_FLAGS flags)
{
   ...
   primary = FindTableMapV (lpv, i)->fields[SCSCHDL_FLD_AUDIT].wOffset;
   if ( HDR_HAS_REVISIONS==0 )
      // Note: this only works for MP3 records
      iHdrPKeySize = (INT) FindTableMapV (lpv, i)->fields[SCSCHDL_FLD_AUDIT - DTL_SEG_COUNT].wOffset;
   else
 ...
 * I/O, copy these corresponding functions out of the scSchdl.C file replacing *
...
DB_ERRNUM WINAPI fileAddBase (WORD wLinkNo, HPIB hpib)
{
   ...
   MaxDatabaseError (&d, ErrorMapViewToDatabase (VIEW_OP_OPEN,
                                                 scSchdlOpen (hpib, wLinkNo, (LPVOID *) &lpv)));
   if ( DB_ERRNUM_IS_SUCCESS (d) ) {
      ...
      if ( !lpv->bRevisioned ) {
         ...
         if ( lpv->bReadOnly ) {
            ...
            FL_ERRNUM f = filterExprFirst (lpv, &lpv->filter,
               (FILTERNAME) xxxNameOnly, (FILTERGET) scSchdlGet, lpv->bAhead, &first);
            ...
            if ( DB_ERRNUM_IS_SUCCESS (d) ) {
               ...
               f = filterExprSegments (lpv, &lpv->filter, nSegs,
                  (FILTERNAME) xxxNameOnly, (FILTERGET) scSchdlGet, &detail);
               RVSPYTRACE (detail);
               filterErrorV (lpv, op, f);
               MaxDatabaseError (&d, ErrorMapFilterToDatabase (op, f));
               if ( DB_ERRNUM_IS_SUCCESS (d) ) {
...
{
   DB_ERRNUM d = DBS_SUCCESS;
   CHAR array[SIZEOF_TABLENAME] = {'S','C','S','C','H','D','L',' '};
   LPSTR name = array;
      ...
      for ( i=BASE_TBL_COUNT; i<BASE_TBL_COUNT+TBL_COUNT; i++ ) {
         ...
         if ( DB_ERRNUM_IS_SUCCESS (d) ) {
            ...
            if ( DBS_DD_INCONSISTENT==d ||
               ...
               // in all subsequent scSchdlInstanceFieldList() calls
            }
         }
         if ( DB_ERRNUM_IS_FAILURE (d) ) {
            while ( --i>=BASE_TBL_COUNT )
...
*/
VIEWCALL scSchdlTableHandles (LPV lpv, INT count, LPWORD handles)
{
   ERRNUM e = ERRNUM_SUCCESS;
   INT i;
   SHORT baseTables = 0;
...
VIEWCALL scSchdlVersionTemplate (INT roto, LPSTR version, LPBCDDATE date)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlVersionAPI (INT roto, LPSTR version)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlViewName (HPIB pib, LPSTR name, INT size)
{
   rscLoadText (pib, APPL, IDS_SCSCHDL_VIEW_NAME, name, size);
   return ERRNUM_SUCCESS;
}



VIEWCALL scSchdlViewTableCount (INT roto, LPSHORT tableCount)
{
   ERRNUM e = ERRNUM_SUCCESS;
...
VIEWCALL scSchdlViewTables (INT roto, LPSTR tableNames, INT size)
{
   INT i;
   SHORT baseTables = 0;
   ERRNUM e = ERRNUM_SUCCESS;
