...
// section in scBal1.c, and using -DSTUB_VIEW on the compiler command line
...
// pass them explicitly via scBalCompose, in which case they will be loaded
...
#define SCBAL_FLD_AUDIT        SCBAL_FLD(AUDTDATE)
//#define SCBAL2_FLD_AUDIT       SCBAL2_FLD(AUDTDATE)


// Number of field indexes published from the view
//#define FLD_IDX_COUNT    (SCBAL_IDX_COUNT)
// if multiple tables are used uncomment the following define in place of the above
#define FLD_IDX_COUNT    (SCBAL_IDX_COUNT + SCBAL2_IDX_COUNT)

// Highest-valued field index + 1 for C-style array dimensioning
#define FLD_IDX_LIMIT    (1+SCBAL_IDX(BALYTD))
...
// Remove comment as required. See scBal1.c file for comments on usage of each
...
// The original semantics are available by calling scBalBaseYYYY()
//#define DO_scBalAttribs             1
//#define DO_scBalBlkGet              1
//#define DO_scBalBlkPut              1
//#define DO_scBalBrowse              1
//#define DO_scBalCancel              1
#define DO_scBalClose               1
//#define DO_scBalCmpNames            1
//#define DO_scBalCompose             1
//#define DO_scBalCreate              1
//#define DO_scBalDelete              1
//#define DO_scBalDirty               1
//#define DO_scBalDrop                1
//#define DO_scBalExists              1
//#define DO_scBalFetch               1
//#define DO_scBalFetchLock           1
//#define DO_scBalField               1
//#define DO_scBalFieldExists         1
//#define DO_scBalFieldName           1
//#define DO_scBalFields              1
//#define DO_scBalFilterDelete        1
//#define DO_scBalFilterFetch         1
//#define DO_scBalFilterSelect        1
//#define DO_scBalGet                 1
//#define DO_scBalInit                1
//#define DO_scBalInsert              1
//#define DO_scBalInstanceFieldList   1
//#define DO_scBalInstanceNotify      1
//#define DO_scBalInstanceOpen        1
//#define DO_scBalInstanceProtocol    1
//#define DO_scBalInstanceSecurity    1
//#define DO_scBalKey                 1
//#define DO_scBalKeys                1
//#define DO_scBalName                1
//#define DO_scBalOpen                1
//#define DO_scBalOrder               1
//#define DO_scBalPost                1
#define DO_scBalPresents            1
//#define DO_scBalProcess             1
//#define DO_scBalPut                 1
//#define DO_scBalRead                1
//#define DO_scBalReadLock            1
//#define DO_scBalRecordClear         1
//#define DO_scBalRecordGenerate      1
//#define DO_scBalRevisionCancel      1
//#define DO_scBalRevisionExists      1
//#define DO_scBalRevisionPost        1
//#define DO_scBalRevisionRekey       1
//#define DO_scBalRevisionUnposted    1
//#define DO_scBalSecurity            1
//#define DO_scBalTableEmpty          1
//#define DO_scBalType                1
//#define DO_scBalUnLock              1
//#define DO_scBalUpdate              1
//#define DO_scBalVerify              1
