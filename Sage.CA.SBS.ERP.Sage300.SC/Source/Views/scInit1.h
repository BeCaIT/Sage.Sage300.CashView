...
// section in scInit1.c, and using -DSTUB_VIEW on the compiler command line
...
// pass them explicitly via scInitCompose, in which case they will be loaded
...
#define SCINIT_FLD_AUDIT        0//SCINIT_FLD(AUDTDATE)
//#define SCINIT2_FLD_AUDIT       SCINIT2_FLD(AUDTDATE)


// Number of field indexes published from the view
#define FLD_IDX_COUNT    (SCINIT_IDX_COUNT)
// if multiple tables are used uncomment the following define in place of the above
//#define FLD_IDX_COUNT    (SCINIT_IDX_COUNT + SCINIT2_IDX_COUNT)

// Highest-valued field index + 1 for C-style array dimensioning
#define FLD_IDX_LIMIT    (1+SCINIT_IDX(PROCESSCMD))
...
// Remove comment as required. See scInit1.c file for comments on usage of each
...
// The original semantics are available by calling scInitBaseYYYY()
//#define DO_scInitAttribs             1
//#define DO_scInitBlkGet              1
//#define DO_scInitBlkPut              1
//#define DO_scInitBrowse              1
//#define DO_scInitCancel              1
#define DO_scInitClose               1
//#define DO_scInitCmpNames            1
//#define DO_scInitCompose             1
//#define DO_scInitCreate              1
//#define DO_scInitDelete              1
//#define DO_scInitDirty               1
//#define DO_scInitDrop                1
//#define DO_scInitExists              1
//#define DO_scInitFetch               1
//#define DO_scInitFetchLock           1
//#define DO_scInitField               1
//#define DO_scInitFieldExists         1
//#define DO_scInitFieldName           1
//#define DO_scInitFields              1
//#define DO_scInitFilterDelete        1
//#define DO_scInitFilterFetch         1
//#define DO_scInitFilterSelect        1
//#define DO_scInitGet                 1
//#define DO_scInitInit                1
//#define DO_scInitInsert              1
//#define DO_scInitInstanceFieldList   1
//#define DO_scInitInstanceNotify      1
//#define DO_scInitInstanceOpen        1
//#define DO_scInitInstanceProtocol    1
//#define DO_scInitInstanceSecurity    1
//#define DO_scInitKey                 1
//#define DO_scInitKeys                1
//#define DO_scInitName                1
//#define DO_scInitOpen                1
//#define DO_scInitOrder               1
//#define DO_scInitPost                1
//#define DO_scInitPresents            1
//#define DO_scInitProcess             1
//#define DO_scInitPut                 1
//#define DO_scInitRead                1
//#define DO_scInitReadLock            1
//#define DO_scInitRecordClear         1
//#define DO_scInitRecordGenerate      1
//#define DO_scInitRevisionCancel      1
//#define DO_scInitRevisionExists      1
//#define DO_scInitRevisionPost        1
//#define DO_scInitRevisionRekey       1
//#define DO_scInitRevisionUnposted    1
//#define DO_scInitSecurity            1
//#define DO_scInitTableEmpty          1
//#define DO_scInitType                1
//#define DO_scInitUnLock              1
//#define DO_scInitUpdate              1
//#define DO_scInitVerify              1
