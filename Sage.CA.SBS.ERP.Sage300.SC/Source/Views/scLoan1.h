...
// section in scLoan1.c, and using -DSTUB_VIEW on the compiler command line
...
// pass them explicitly via scLoanCompose, in which case they will be loaded
...
#define SCLOAN_FLD_AUDIT        SCLOAN_FLD(AUDTDATE)
//#define SCLOAN2_FLD_AUDIT       SCLOAN2_FLD(AUDTDATE)


// Number of field indexes published from the view
//#define FLD_IDX_COUNT    (SCLOAN_IDX_COUNT)
// if multiple tables are used uncomment the following define in place of the above
#define FLD_IDX_COUNT    (SCLOAN_IDX_COUNT + SCLOAN2_IDX_COUNT)

// Highest-valued field index + 1 for C-style array dimensioning
#define FLD_IDX_LIMIT    (1+SCLOAN_IDX(EMAILTO))
...
// Remove comment as required. See scLoan1.c file for comments on usage of each
...
// The original semantics are available by calling scLoanBaseYYYY()
//#define DO_scLoanAttribs             1
//#define DO_scLoanBlkGet              1
//#define DO_scLoanBlkPut              1
//#define DO_scLoanBrowse              1
//#define DO_scLoanCancel              1
#define DO_scLoanClose               1
//#define DO_scLoanCmpNames            1
//#define DO_scLoanCompose             1
//#define DO_scLoanCreate              1
//#define DO_scLoanDelete              1
//#define DO_scLoanDirty               1
//#define DO_scLoanDrop                1
//#define DO_scLoanExists              1
//#define DO_scLoanFetch               1
//#define DO_scLoanFetchLock           1
//#define DO_scLoanField               1
//#define DO_scLoanFieldExists         1
//#define DO_scLoanFieldName           1
//#define DO_scLoanFields              1
//#define DO_scLoanFilterDelete        1
//#define DO_scLoanFilterFetch         1
//#define DO_scLoanFilterSelect        1
//#define DO_scLoanGet                 1
//#define DO_scLoanInit                1
#define DO_scLoanInsert              1
//#define DO_scLoanInstanceFieldList   1
//#define DO_scLoanInstanceNotify      1
//#define DO_scLoanInstanceOpen        1
//#define DO_scLoanInstanceProtocol    1
//#define DO_scLoanInstanceSecurity    1
//#define DO_scLoanKey                 1
//#define DO_scLoanKeys                1
//#define DO_scLoanName                1
//#define DO_scLoanOpen                1
//#define DO_scLoanOrder               1
//#define DO_scLoanPost                1
#define DO_scLoanPresents            1
//#define DO_scLoanProcess             1
//#define DO_scLoanPut                 1
//#define DO_scLoanRead                1
//#define DO_scLoanReadLock            1
//#define DO_scLoanRecordClear         1
//#define DO_scLoanRecordGenerate      1
//#define DO_scLoanRevisionCancel      1
//#define DO_scLoanRevisionExists      1
//#define DO_scLoanRevisionPost        1
//#define DO_scLoanRevisionRekey       1
//#define DO_scLoanRevisionUnposted    1
//#define DO_scLoanSecurity            1
//#define DO_scLoanTableEmpty          1
//#define DO_scLoanType                1
//#define DO_scLoanUnLock              1
#define DO_scLoanUpdate              1
//#define DO_scLoanVerify              1
